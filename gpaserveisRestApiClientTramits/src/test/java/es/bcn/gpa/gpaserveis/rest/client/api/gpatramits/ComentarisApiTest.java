...
public class ComentarisApiTest extends ParentTest {
	...
	public void createComentarisUsingPOSTTest() throws ApiException {
		when(apiClient.invokeAPI(eq("/tramits/comentaris"), eq("POST"), any(List.class), any(Object.class), any(Map.class), any(Map.class),
	...
	public void deleteComentarisListUsingPOSTTest() throws ApiException {
		when(apiClient.invokeAPI(eq("/tramits/comentaris/delete"), eq("POST"), any(List.class), any(Object.class), any(Map.class),
	...
	public void updateComentarisUsingPUTTest() throws ApiException {
		when(apiClient.invokeAPI(eq("/tramits/comentaris"), eq("PUT"), any(List.class), any(Object.class), any(Map.class), any(Map.class),
		        isNull(String.class), isNull(String.class), any(String[].class), any(GenericType.class)))
		                .thenReturn(new PageDataOfComentarisRDTO());
