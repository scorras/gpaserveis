...
public class ExpedientsApiTest extends ParentTest {
	 ...
	 */
	@Test
	public void altaExpedientOpentextUsingPOSTTest() throws ApiException {
		when(apiClient.invokeAPI(eq("/documentacio/altaExpedientOpentext"), eq("POST"), any(List.class), any(Object.class), any(Map.class),
