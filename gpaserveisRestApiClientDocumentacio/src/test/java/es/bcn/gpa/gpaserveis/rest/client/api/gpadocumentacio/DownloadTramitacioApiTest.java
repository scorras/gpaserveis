...
public class DownloadTramitacioApiTest extends ParentTest {

	@InjectMocks
	private DownloadTramitacioApi api = new DownloadTramitacioApi();
	 ...
	 */
	@Test
	public void downloadFileTramitacioUsingGETTest() throws RestClientException {
		when(apiClient.invokeAPI(eq("/documentacio/downloadFileTramitacio/1/1"), eq(HttpMethod.GET), any(MultiValueMap.class),
