...
public class DownloadTramitacioApiTest extends ParentTest {
	 ...
	 */
	@Test
	public void downloadFileTramitacioUsingGETTest() throws ApiException {
		when(apiClient.escapeString(any(String.class))).thenReturn(ONE.toString());
		when(apiClient.invokeAPI(eq("/documentacio/downloadFileTramitacio/1/1"), eq("GET"), any(List.class), any(Object.class),
