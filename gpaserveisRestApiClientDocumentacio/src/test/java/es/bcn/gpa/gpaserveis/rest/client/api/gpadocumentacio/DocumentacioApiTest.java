...
public class DocumentacioApiTest extends ParentTest {
	 ...
	 */
	@Test
	public void consultarEstatDigitalitzacioTest() {
		when(apiClient.invokeAPI(eq("/documentacio/estatDigitalitzacio/1"), eq(HttpMethod.GET), any(MultiValueMap.class), any(Object.class),
				any(HttpHeaders.class), any(MultiValueMap.class), any(List.class), any(MediaType.class), any(String[].class),
				any(ParameterizedTypeReference.class))).thenReturn(new PeticionsDigitalitzacioRDTO());

		String idPeticio = ONE.toString();
		PeticionsDigitalitzacioRDTO response = api.consultarEstatDigitalitzacio(idPeticio);
	...
	public void guardarXmlSollicitudTest() throws RestClientException, IOException {
		...
		File file = testFolder.newFolder("test");
		api.guardarXmlSollicitud(file, idDocumentum);
