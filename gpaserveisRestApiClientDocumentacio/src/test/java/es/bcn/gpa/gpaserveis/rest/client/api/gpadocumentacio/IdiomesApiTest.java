...
public class IdiomesApiTest extends ParentTest {
	 ...
	 */
	@Test
	public void obtenirIdiomesUsingGETTest() throws RestClientException {
		when(apiClient.invokeAPI(eq("/documentacio/catalog/idiomes"), eq(HttpMethod.GET), any(MultiValueMap.class), any(Object.class),
		        any(HttpHeaders.class), any(MultiValueMap.class), any(List.class), any(MediaType.class), any(String[].class),
		        any(ParameterizedTypeReference.class))).thenReturn(new ArrayList<IdiomesRDTO>());
