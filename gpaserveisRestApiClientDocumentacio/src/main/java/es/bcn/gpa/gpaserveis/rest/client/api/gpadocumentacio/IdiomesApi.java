...
public class IdiomesApi {
   ...
   */
  public List<IdiomesRDTO> obtenirIdiomesUsingGET() throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/documentacio/catalog/idiomes";
    ...
    GenericType<List<IdiomesRDTO>> localVarReturnType = new GenericType<List<IdiomesRDTO>>() {};
