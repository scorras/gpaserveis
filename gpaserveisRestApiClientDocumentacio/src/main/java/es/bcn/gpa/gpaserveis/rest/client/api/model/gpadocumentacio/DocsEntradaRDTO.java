...
public class DocsEntradaRDTO {
	...
	@Override
	public int hashCode() {
		return Objects.hash(codi, comentari, configDocEntrada, configuracioDocsEntrada, configuracioDocsEntradaNom,
				configuracioDocsEntradaNomCastella, dataCreacio, dataDigitalitzacio, dataPresentacio, dataUltimaModificacio,
				declaracioResponsable, digitalitzat, docsFisics, docsFisicsNom, documentFisic, documentacio, editable, eliminat,
				estatDigitalitzacio, id, idIdiomaPlantilla, idioma, idiomaDigitalitzacio, metadata, migracioIdOrigen, nou,
				numDocsConfiguracio, obligatoriEnEstat, origen, plantillaPdf, registreAssentament, registreCodi, registreIdext, requerit,
				revisio, seleccionable, tipusMimeDescripcio, tramitOvtIdext, ultimaModificacioIdext, urlDigitalitzacio, usuariIdext);
	}
