...
public class ConfiguracioDocsTramitacioRDTO {
  ...
  @JsonProperty("confDocsTramPolitiquesSigList")
  private List<ConfDocsTramPolitiquesSig> confDocsTramPolitiquesSigList = null;
  ...
  @JsonProperty("criticitatIdext")
  private Integer criticitatIdext = null;
  ...
  @JsonProperty("transicioCompletat")
  private Integer transicioCompletat = null;
  ...
  **/
  ...
  public ConfiguracioDocsTramitacioRDTO confDocsTramPolitiquesSigList(List<ConfDocsTramPolitiquesSig> confDocsTramPolitiquesSigList) {
    this.confDocsTramPolitiquesSigList = confDocsTramPolitiquesSigList;
    return this;
  }

  public ConfiguracioDocsTramitacioRDTO addConfDocsTramPolitiquesSigListItem(ConfDocsTramPolitiquesSig confDocsTramPolitiquesSigListItem) {
    if (this.confDocsTramPolitiquesSigList == null) {
      this.confDocsTramPolitiquesSigList = new ArrayList<ConfDocsTramPolitiquesSig>();
    }
    this.confDocsTramPolitiquesSigList.add(confDocsTramPolitiquesSigListItem);
    return this;
  }

   /**
   * Get confDocsTramPolitiquesSigList
   * @return confDocsTramPolitiquesSigList
  **/
  @ApiModelProperty(value = "")
  public List<ConfDocsTramPolitiquesSig> getConfDocsTramPolitiquesSigList() {
    return confDocsTramPolitiquesSigList;
  }

  public void setConfDocsTramPolitiquesSigList(List<ConfDocsTramPolitiquesSig> confDocsTramPolitiquesSigList) {
    this.confDocsTramPolitiquesSigList = confDocsTramPolitiquesSigList;
  }
  ...
  **/
  ...
  public ConfiguracioDocsTramitacioRDTO criticitatIdext(Integer criticitatIdext) {
    this.criticitatIdext = criticitatIdext;
    return this;
  }

   /**
   * Get criticitatIdext
   * @return criticitatIdext
  **/
  @ApiModelProperty(value = "")
  public Integer getCriticitatIdext() {
    return criticitatIdext;
  }

  public void setCriticitatIdext(Integer criticitatIdext) {
    this.criticitatIdext = criticitatIdext;
  }
  ...
  **/
  ...
  public ConfiguracioDocsTramitacioRDTO descripcioCastella(String descripcioCastella) {
  ...
  **/
  ...
  public ConfiguracioDocsTramitacioRDTO editable(Boolean editable) {
  ...
  **/
  ...
  public ConfiguracioDocsTramitacioRDTO seleccionable(Boolean seleccionable) {
  ...
  **/
  ...
  public ConfiguracioDocsTramitacioRDTO transicioCompletat(Integer transicioCompletat) {
    this.transicioCompletat = transicioCompletat;
    return this;
  }

   /**
   * Get transicioCompletat
   * @return transicioCompletat
  **/
  @ApiModelProperty(value = "")
  public Integer getTransicioCompletat() {
    return transicioCompletat;
  }

  public void setTransicioCompletat(Integer transicioCompletat) {
    this.transicioCompletat = transicioCompletat;
  }
  ...
  **/
  ...
  public ConfiguracioDocsTramitacioRDTO visibilitatPortal(Integer visibilitatPortal) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.atributDoc, configuracioDocsTramitacioRDTO.atributDoc) &&
        ...
        Objects.equals(this.confDocsTramPolitiquesSigList, configuracioDocsTramitacioRDTO.confDocsTramPolitiquesSigList) &&
        ...
        Objects.equals(this.criticitatIdext, configuracioDocsTramitacioRDTO.criticitatIdext) &&
        Objects.equals(this.descripcio, configuracioDocsTramitacioRDTO.descripcio) &&
        Objects.equals(this.descripcioCastella, configuracioDocsTramitacioRDTO.descripcioCastella) &&
        ...
        Objects.equals(this.editable, configuracioDocsTramitacioRDTO.editable) &&
        ...
        Objects.equals(this.seleccionable, configuracioDocsTramitacioRDTO.seleccionable) &&
        ...
        Objects.equals(this.transicioCompletat, configuracioDocsTramitacioRDTO.transicioCompletat) &&
        Objects.equals(this.uniqueId, configuracioDocsTramitacioRDTO.uniqueId) &&
        Objects.equals(this.visibilitatPortal, configuracioDocsTramitacioRDTO.visibilitatPortal);
  }

  @Override
  public int hashCode() {
    return Objects.hash(atributDoc, atributsDocs, codiNti, confDocsTramPolitiquesSigList, confdocstramEstatsExpList, confdocstramTramitsOvtList, configuracioDocsSignatura, configuracioDocumentacio, configuracioSignatura, criticitatIdext, descripcio, descripcioCastella, detallOrigen, documentacioVinculada, editable, fase, id, nom, nomCastella, nomNti, origen, requereixSignatura, seleccionable, suportConfeccio, suportEnllac, tipusDocumental, tractament, transicioCompletat, uniqueId, visibilitatPortal);
  }
  ...
  public String toString() {
    ...
    sb.append("    confDocsTramPolitiquesSigList: ").append(toIndentedString(confDocsTramPolitiquesSigList)).append("\n");
    ...
    sb.append("    criticitatIdext: ").append(toIndentedString(criticitatIdext)).append("\n");
    ...
    sb.append("    transicioCompletat: ").append(toIndentedString(transicioCompletat)).append("\n");
