...
public class CallbackPortaSig {
	...
	/**
	 * Indicador de l&#39;estat global de la petició, o buit en cas que es
	 * produeixi un error
	 * 
	 * @return codiEstat
	 **/
	...
	/**
	 * Identificador assignat pel Portasignatures en el moment d&#39;acceptar la
	 * petició
	 * 
	 * @return codiPeticio
	 **/
	...
	/**
	 * Identificador ControlUser de l&#39;usuari que ha de signar/validar el
	 * document
	 * 
	 * @return codiUsuari
	 **/
	...
	/**
	 * Data, hora i minut límit abans de considerar aquest pas de la petició
	 * global com caducada i no permetre a l&#39;usuari d&#39;aquest pas signar
	 * el document. Si es supera la dataCaducitat en un pas, tota la petició
	 * global és considerada caducada, i l&#39;aplicació origen és notificada
	 * 
	...
	/**
	 * Instant (data i hora) en que l&#39;usuari va signar el document. No més
	 * es retorna si al demanar el alta de la petició es va indicar un valor de
	 * versioIntegracio igual o major que 2. Aquest camp pot no estar informat o
	 * estar buit, depenent de l&#39;estat d&#39;aquest pas.
	 * 
	...
	/**
	 * Si el document ja ha sigut signat/vist-i-plau, en aquest camp
	 * s&#39;informa el id assignat pel Mòdul de Signatura a aquesta signatura/
	 * vist-i-plau. La aplicació client pot fer servir APIs del Mòdul de
	 * Signatura per a obtindre les dades de la signatura (timestamp, common
	 * name del certificat del signatari...)
	 * 
	...
	/**
	 * Amb 2 valors possibles: SIGNATURA i VIST_I_PLAU, indicant si es demana de
	 * l&#39;usuari que signi o que validi el document
	 * 
	 * @return tipusPeticio
	 **/
	...
	@Override
	public int hashCode() {
		return Objects.hash(codiEstat, codiPeticio, codiUsuari, dataCaducitat, instantSignatura, nifUsuari, nomCompletUsuari, ticketPeticio,
				tipusPeticio);
	}
