...
public class SignaturesApi {
	 ...
	 * <b>404</b> - Not Found
	 * 
	 * @param signarPortasignaturesDocumentRDTO
	 *            signarPortasignaturesDocumentRDTO
	 * @return PeticionsPortasig
	 * @throws RestClientException
	 *             if an error occurs while attempting to invoke the API
	 */
	public PeticionsPortasig crearPeticioPortaSig(SignarPortasignaturesDocument signarPortasignaturesDocumentRDTO)
			throws RestClientException {
		Object postBody = signarPortasignaturesDocumentRDTO;

		// verify the required parameter 'signarPortasignaturesDocumentRDTO' is
		// set
		if (signarPortasignaturesDocumentRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'signarPortasignaturesDocumentRDTO' when calling crearPeticioPortaSig");
		}
	...
	public byte[] descarregarDocumentExpedientSignat(BigDecimal idUltimaSignatura) throws RestClientException {
		...
		if (idUltimaSignatura == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'idUltimaSignatura' when calling descarregarDocumentExpedientSignat");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idUltimaSignatura", idUltimaSignatura);
		String path = UriComponentsBuilder.fromPath("/signatures/descarregarDocumentExpedientSignat/{idUltimaSignatura}")
	 ...
	 * <b>404</b> - Not Found
	 * 
	 * @param callbackManuscritaRDTO
	 *            callbackManuscritaRDTO
	 * @throws RestClientException
	 *             if an error occurs while attempting to invoke the API
	 */
	public void finalitzarSignaturaTablet(CallbackManuscrita callbackManuscritaRDTO) throws RestClientException {
		...
		if (callbackManuscritaRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'callbackManuscritaRDTO' when calling finalitzarSignaturaTablet");
		}
	...
	public Boolean peticioAmbDocumentsSignats(String idPeticio) throws RestClientException {
		...
		if (idPeticio == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'idPeticio' when calling peticioAmbDocumentsSignats");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idPeticio", idPeticio);
		String path = UriComponentsBuilder.fromPath("/signatures/peticioAmbDocumentsSignats/{idPeticio}").buildAndExpand(uriVariables)
				.toUriString();
	...
	public void incrementarReintentsSignatura(BigDecimal idDocument) throws RestClientException {
		...
		if (idDocument == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'idDocument' when calling incrementarReintentsSignatura");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idDocument", idDocument);
		String path = UriComponentsBuilder.fromPath("/signatures/incrementarReintentsSignatura/{idDocument}").buildAndExpand(uriVariables)
				.toUriString();
