...
public class DocsTramitacioRDTO {
	...
	public int hashCode() {
		return Objects.hash(canalComunicat, codi, comentari, comunicat, configDocTramitacio, configuracioDocsTramitacio,
		        configuracioDocsTramitacioNom, dataComunicat, dataCreacio, dataDigitalitzacio, dataUltimaModificacio, descripcioEstat,
		        digitalitzat, docsFisics, docsFisicsNom, docsSignatures, docsTercers, documentFisic, documentacio, editable, eliminat,
		        estat, estatAnterior, estatDigitalitzacio, estatDocsTramitacio, estatsDocsTramitacio, hash, id, idioma,
		        idiomaDigitalitzacio, metadata, migracioIdOrigen, missatgeComunicat, notificacio, notificacions, numDocsConfiguracio,
		        obligatoriEnEstat, origen, plantillaPdf, publicarInfoPublica, registreAssentament, registreIdext, requereixSignatura,
		        requeriments, seleccionable, tipusMimeDescripcio, ultimaModificacioIdext, ultimaSignatura, urlDigitalitzacio, usuariIdext,
		        usuariSignaturaNom);
	}
