...
public class AccessRestringutApi {
   ...
   */
  public List<AccessRestringutRDTO> getAccessRestringutUsingGET() throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/documentacio/catalog/accessRestringut";
    ...
    GenericType<List<AccessRestringutRDTO>> localVarReturnType = new GenericType<List<AccessRestringutRDTO>>() {};
