...
public class DocumentacioApi {
    ...
    public void cancelarSignarDocumentUsingPOST(BigDecimal idDocument) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/documentacio/cancelarPeticioPortaSig/{idDocument}").buildAndExpand(uriVariables).toUriString();
    ...
    public List<DocsEntradaRDTO> cercaDocumentsEntradaAgrupatsPerTramitOvt(BigDecimal idDocumentacio) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/documentacio/{idDocumentacio}/entrada/agrupatPerTramitOvt").buildAndExpand(uriVariables).toUriString();
    ...
    public Boolean comprovarDocumentsSignatsUsingGET(BigDecimal idDocumentacio) throws RestClientException {
        ...
        // verify the required parameter 'idDocumentacio' is set
        if (idDocumentacio == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'idDocumentacio' when calling comprovarDocumentsSignatsUsingGET");
        }
        
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("idDocumentacio", idDocumentacio);
        String path = UriComponentsBuilder.fromPath("/documentacio/comprovarDocumentsSignats/{idDocumentacio}").buildAndExpand(uriVariables).toUriString();
     ...
     * <p><b>403</b> - Forbidden
     * <p><b>404</b> - Not Found
     * @param signarDocumentRDTO signarDocumentRDTO
    ...
    public PeticionsPortasig crearPeticioPortaSig(SignarDocument signarDocumentRDTO) throws RestClientException {
        ...
        if (signarDocumentRDTO == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'signarDocumentRDTO' when calling crearPeticioPortaSig");
        }
     ...
     * <p><b>403</b> - Forbidden
     * <p><b>404</b> - Not Found
     * @param docsTramitacioIds docsTramitacioIds
     * @param idExpedient idExpedient
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void deleteDocumentacioTramitacioUsingPOST(List<BigDecimal> docsTramitacioIds, BigDecimal idExpedient) throws RestClientException {
        Object postBody = docsTramitacioIds;
        
        // verify the required parameter 'docsTramitacioIds' is set
        if (docsTramitacioIds == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'docsTramitacioIds' when calling deleteDocumentacioTramitacioUsingPOST");
        }
        
        // verify the required parameter 'idExpedient' is set
        if (idExpedient == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'idExpedient' when calling deleteDocumentacioTramitacioUsingPOST");
        }
        
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("idExpedient", idExpedient);
        String path = UriComponentsBuilder.fromPath("/documentacio/tramitacio/delete/{idExpedient}").buildAndExpand(uriVariables).toUriString();
     ...
     * <p><b>403</b> - Forbidden
     * <p><b>404</b> - Not Found
     * @param docsEntradaIds docsEntradaIds
     * @param idExpedient idExpedient
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void esborrarDocumentExpedient(List<BigDecimal> docsEntradaIds, BigDecimal idExpedient) throws RestClientException {
        ...
        if (docsEntradaIds == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'docsEntradaIds' when calling esborrarDocumentExpedient");
        }
        
        // verify the required parameter 'idExpedient' is set
        if (idExpedient == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'idExpedient' when calling esborrarDocumentExpedient");
        }
        
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("idExpedient", idExpedient);
        String path = UriComponentsBuilder.fromPath("/documentacio/entrada/delete/{idExpedient}").buildAndExpand(uriVariables).toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Map<String, String> obtenirDocumentsEntradaToRegistreUsingGET(String documents) throws RestClientException {
        Object postBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Map<String, String> obtenirDocumentsToRegistreUsingGET(BigDecimal idDocumentacio) throws RestClientException {
        Object postBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<TransicionsEstatsRDTO> obtenirTransicionsEstatsByEstatDocTramUsingGET(BigDecimal estatDocTramitacio) throws RestClientException {
        Object postBody = null;
        ...
        String path = UriComponentsBuilder.fromPath("/documentacio/tramitacio/estatsDocTramCanviEstat/{estatDocTramitacio}").buildAndExpand(uriVariables).toUriString();
