...
public class DocumentacioApi {
	...
	public DocsEntradaRDTO actualitzarDeclaracioResponsable(DocsEntradaRDTO docsEntradaRDTO, BigDecimal idExpedient) throws ApiException {
		...
		String localVarPath = "/documentacio/entrada/responsable/{idExpedient}".replaceAll("\\{" + "idExpedient" + "\\}",
	...
	public DocsEntradaRDTO actualitzarDocumentEntrada(DocsEntradaRDTO docsEntradaRDTO, BigDecimal idExpedient) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/documentacio/entrada/{idExpedient}".replaceAll("\\{" + "idExpedient" + "\\}",
		        apiClient.escapeString(idExpedient.toString()));
	...
	public DocsTramitacioRDTO actualitzarDocumentTramitacio(DocsTramitacioRDTO docsTramitacioRDTO, BigDecimal idExpedient)
		...
		// create path and map variables
		String localVarPath = "/documentacio/tramitacio/{idExpedient}".replaceAll("\\{" + "idExpedient" + "\\}",
		        apiClient.escapeString(idExpedient.toString()));
	 ...
	 *            guardarRequerimentExpedientRDTO (required)
	 * @param idExpedient
	 *            idExpedient (required)
	 * @return DocsTramitacioRDTO
	 * @throws ApiException
	...
	public DocsTramitacioRDTO actualitzarRequeriment(GuardarRequerimentExpedient guardarRequerimentExpedientRDTO, BigDecimal idExpedient)
		...
		// create path and map variables
		String localVarPath = "/documentacio/requeriment/{idExpedient}".replaceAll("\\{" + "idExpedient" + "\\}",
		        apiClient.escapeString(idExpedient.toString()));
	 ...
	 *            acumularDocumentacioRDTO (required)
	 ...
	 *            docsEntActualizarRegistreRDTO (required)
	 * @throws ApiException
	 *             if fails to make API call
	 */
	 ...
	 *            documentActualizarRegistreRDTO (required)
	 * @throws ApiException
	 *             if fails to make API call
	 */
	...
	public void cancelarSignarDocumentUsingPOST(BigDecimal idDocument) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/documentacio/cancelarPeticioPortaSig/{idDocument}".replaceAll("\\{" + "idDocument" + "\\}",
		        apiClient.escapeString(idDocument.toString()));
	 ...
	 *            documentCanviEstatRDTO (required)
	 * @throws ApiException
	 *             if fails to make API call
	 */
	...
	public List<BigDecimal> cercaDadesOperacioRequerits(BigDecimal idDoc) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/documentacio/dadesOperRequerit/{idDoc}".replaceAll("\\{" + "idDoc" + "\\}",
		        apiClient.escapeString(idDoc.toString()));
	...
	public List<DocsEntradaRDTO> cercaDocumentsEntradaAgrupatsPerTramitOvt(BigDecimal idDocumentacio) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/documentacio/{idDocumentacio}/entrada/agrupatPerTramitOvt".replaceAll("\\{" + "idDocumentacio" + "\\}",
		        apiClient.escapeString(idDocumentacio.toString()));
	...
	public Boolean comprovarDocumentsSignatsUsingGET(BigDecimal idDocumentacio) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/documentacio/comprovarDocumentsSignats/{idDocumentacio}".replaceAll("\\{" + "idDocumentacio" + "\\}",
		        apiClient.escapeString(idDocumentacio.toString()));
	...
	public DocsEntradaRDTO consultarDadesDocumentAportat(BigDecimal id) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/documentacio/entrada/{id}".replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
	...
	public DocsTramitacioRDTO consultarDadesDocumentGenerat(BigDecimal id) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/documentacio/tramitacio/{id}".replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
	...
	public void deleteDocumentacioTramitacioUsingPOST(List<BigDecimal> docsTramitacioIds, BigDecimal idExpedient) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/documentacio/tramitacio/delete/{idExpedient}".replaceAll("\\{" + "idExpedient" + "\\}",
		        apiClient.escapeString(idExpedient.toString()));
	...
	public void esborrarDocumentExpedient(List<BigDecimal> docsEntradaIds, BigDecimal idExpedient) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/documentacio/entrada/delete/{idExpedient}".replaceAll("\\{" + "idExpedient" + "\\}",
		        apiClient.escapeString(idExpedient.toString()));
	 ...
	 *            estatsFutursList (required)
	 * @param idConfiguracioDocumentacio
	 *            idConfiguracioDocumentacio (required)
	 * @param idDocumentacio
	 *            idDocumentacio (required)
	...
	public List<ConfiguracioDocsEntradaRDTO> getTipusGrupEntradaUsingGET(BigDecimal idConfigDoc) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/documentacio/entrada/listTipusGrup/{idConfigDoc}".replaceAll("\\{" + "idConfigDoc" + "\\}",
		        apiClient.escapeString(idConfigDoc.toString()));
	...
	public List<ConfiguracioDocsTramitacioRDTO> getTipusGrupTramitacioUsingGET(BigDecimal idConfigDoc) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/documentacio/tramitacio/listTipusGrup/{idConfigDoc}".replaceAll("\\{" + "idConfigDoc" + "\\}",
		        apiClient.escapeString(idConfigDoc.toString()));
	 ...
	 *             if fails to make API call
	 */
	public DocsEntradaRDTO guardarDocumentEntradaFitxer(String docsEntrada, org.springframework.web.multipart.MultipartFile file,
	        BigDecimal idExpedient) throws ApiException {
		Object localVarPostBody = null;
		...
		// create path and map variables
		String localVarPath = "/documentacio/entrada/fitxer/{idExpedient}".replaceAll("\\{" + "idExpedient" + "\\}",
		        apiClient.escapeString(idExpedient.toString()));
	 ...
	 *             if fails to make API call
	 */
	public DocsTramitacioRDTO guardarDocumentTramitacioFitxer(String docsTramitacio, org.springframework.web.multipart.MultipartFile file,
	        BigDecimal idExpedient) throws ApiException {
		Object localVarPostBody = null;
		...
		// create path and map variables
		String localVarPath = "/documentacio/tramitacio/fitxer/{idExpedient}".replaceAll("\\{" + "idExpedient" + "\\}",
		        apiClient.escapeString(idExpedient.toString()));
	...
	public DocsTramitacioRDTO guardarDocumentTramitacioPlantilla(DocsTramitacioRDTO docsTramitacioRDTO, BigDecimal idExpedient)
		...
		// create path and map variables
		String localVarPath = "/documentacio/tramitacio/plantilla/{idExpedient}".replaceAll("\\{" + "idExpedient" + "\\}",
		        apiClient.escapeString(idExpedient.toString()));
	 ...
	 *            requerimentExpedient (required)
	 * @return DocsTramitacioRDTO
	 * @throws ApiException
	 *             if fails to make API call
	 */
	public DocsTramitacioRDTO guardarRequerimentFitxer(org.springframework.web.multipart.MultipartFile file, BigDecimal idExpedient,
	        String requerimentExpedient) throws ApiException {
		Object localVarPostBody = null;
		...
		// create path and map variables
		String localVarPath = "/documentacio/requeriment/fitxer/{idExpedient}".replaceAll("\\{" + "idExpedient" + "\\}",
		        apiClient.escapeString(idExpedient.toString()));
	...
	public DocsTramitacioRDTO guardarRequerimentPlantilla(GuardarRequerimentExpedient guardarRequerimentExpedientRDTO,
		...
		// create path and map variables
		String localVarPath = "/documentacio/requeriment/plantilla/{idExpedient}".replaceAll("\\{" + "idExpedient" + "\\}",
		        apiClient.escapeString(idExpedient.toString()));
	...
	public DocsTramitacioRDTO obtenirDocsTramitacioByNotificationId(BigDecimal idNotificacio) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/documentacio/docsTramitacioByNotificationId/{idNotificacio}".replaceAll("\\{" + "idNotificacio" + "\\}",
		        apiClient.escapeString(idNotificacio.toString()));
	...
	public void tancarRequerimentsExpedient(BigDecimal idDocumentacio) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/documentacio/tancarRequeriments/{idDocumentacio}".replaceAll("\\{" + "idDocumentacio" + "\\}",
		        apiClient.escapeString(idDocumentacio.toString()));
