...
public class DocumentacioApi {
    ...
    public List<DocsEntradaRDTO> cercaDocumentsEntradaPerSollicitud(BigDecimal idSollicitud) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/documentacio/entrada/sollicitud/{idSollicitud}").buildAndExpand(uriVariables).toUriString();
    ...
    public DocsEntradaRDTO consultarDadesDocumentAportatPerCodiCSV(String codiCSV) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/documentacio/entrada/consultarDadesDocument/{codiCSV}").buildAndExpand(uriVariables).toUriString();
    ...
    public DocsTramitacioRDTO consultarDadesDocumentGeneratPerCodiCSV(String codiCSV) throws RestClientException {
        ...
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("codiCSV", codiCSV);
        String path = UriComponentsBuilder.fromPath("/documentacio/tramitacio/consultarDadesDocument/{codiCSV}").buildAndExpand(uriVariables).toUriString();
    ...
    public DadesSignatura consultarDadesSignatura(String codiPeticio) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/documentacio/dadesSignatura/{codiPeticio}").buildAndExpand(uriVariables).toUriString();
