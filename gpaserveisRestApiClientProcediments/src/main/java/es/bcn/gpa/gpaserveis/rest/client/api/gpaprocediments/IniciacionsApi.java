...
public class IniciacionsApi {
   ...
   */
  public List<IniciacionsRDTO> getIniciacionsUsingGET() throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/procediments/catalog/iniciacions";
    ...
    GenericType<List<IniciacionsRDTO>> localVarReturnType = new GenericType<List<IniciacionsRDTO>>() {};
