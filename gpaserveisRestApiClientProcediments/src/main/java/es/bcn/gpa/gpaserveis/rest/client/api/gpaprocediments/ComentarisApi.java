...
import es.bcn.gpa.gpaserveis.rest.client.api.model.gpaprocediments.ComentarisRDTO;
...
@Component("es.bcn.gpa.gpaserveis.rest.client.api.gpaprocediments.ComentarisApi")
public class ComentarisApi {
     ...
     * <p><b>403</b> - Forbidden
     * <p><b>404</b> - Not Found
     * @param comentarisRDTO comentarisRDTO
    ...
    public PageDataOfComentarisRDTO createComentarisUsingPOST(ComentarisRDTO comentarisRDTO, Integer absoluteRowNumberOfFirstRowInCurrentPage, Integer absoluteRowNumberOfLastRowInCurrentPage, Boolean currentPageHasNextPage, Boolean currentPageHasPreviousPage, Boolean currentPageIsFirstPage, Boolean currentPageIsLastPage, Integer currentPageNumber, String dir, Integer nextPageNumber, Integer pageSize, Integer previousPageNumber, String sort, Long totalElements, Integer totalPages) throws RestClientException {
        Object postBody = comentarisRDTO;
        
        // verify the required parameter 'comentarisRDTO' is set
        if (comentarisRDTO == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'comentarisRDTO' when calling createComentarisUsingPOST");
        }
        
        String path = UriComponentsBuilder.fromPath("/procediments/comentaris").build().toUriString();
     ...
     * <p><b>403</b> - Forbidden
     * <p><b>404</b> - Not Found
     * @param comentarisRDTOList comentarisRDTOList
     * @param absoluteRowNumberOfFirstRowInCurrentPage The absoluteRowNumberOfFirstRowInCurrentPage parameter
     * @param absoluteRowNumberOfLastRowInCurrentPage The absoluteRowNumberOfLastRowInCurrentPage parameter
     * @param currentPageHasNextPage The currentPageHasNextPage parameter
     * @param currentPageHasPreviousPage The currentPageHasPreviousPage parameter
    ...
    public PageDataOfComentarisRDTO deleteComentarisListUsingPOST(List<ComentarisRDTO> comentarisRDTOList, Integer absoluteRowNumberOfFirstRowInCurrentPage, Integer absoluteRowNumberOfLastRowInCurrentPage, Boolean currentPageHasNextPage, Boolean currentPageHasPreviousPage, Boolean currentPageIsFirstPage, Boolean currentPageIsLastPage, Integer currentPageNumber, String dir, Integer nextPageNumber, Integer pageSize, Integer previousPageNumber, String sort, Long totalElements, Integer totalPages) throws RestClientException {
        Object postBody = comentarisRDTOList;
        
        // verify the required parameter 'comentarisRDTOList' is set
        if (comentarisRDTOList == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'comentarisRDTOList' when calling deleteComentarisListUsingPOST");
        }
        
        String path = UriComponentsBuilder.fromPath("/procediments/comentaris/delete").build().toUriString();
    ...
    public PageDataOfComentarisRDTO updateComentarisUsingPUT(ComentarisRDTO comentarisRDTO, Integer absoluteRowNumberOfFirstRowInCurrentPage, Integer absoluteRowNumberOfLastRowInCurrentPage, Boolean currentPageHasNextPage, Boolean currentPageHasPreviousPage, Boolean currentPageIsFirstPage, Boolean currentPageIsLastPage, Integer currentPageNumber, String dir, Integer nextPageNumber, Integer pageSize, Integer previousPageNumber, String sort, Long totalElements, Integer totalPages) throws RestClientException {
        ...
        // verify the required parameter 'comentarisRDTO' is set
        if (comentarisRDTO == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'comentarisRDTO' when calling updateComentarisUsingPUT");
        }
     ...
     * <p><b>403</b> - Forbidden
     * <p><b>404</b> - Not Found
     * @param idUsuaricComentari idUsuaricComentari
     * @return Boolean
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Boolean usuariPropietariComentariUsingGET(Integer idUsuaricComentari) throws RestClientException {
        Object postBody = null;
        
        // verify the required parameter 'idUsuaricComentari' is set
        if (idUsuaricComentari == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'idUsuaricComentari' when calling usuariPropietariComentariUsingGET");
        }
        
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("idUsuaricComentari", idUsuaricComentari);
        String path = UriComponentsBuilder.fromPath("/procediments/comentaris/usuariPropietariComentari/{idUsuaricComentari}").buildAndExpand(uriVariables).toUriString();
