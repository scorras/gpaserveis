...
public class DadesGrupApi {
   ...
   */
  public void deleteDadesGrupsUsingPOST(List<BigDecimal> idList) throws ApiException {
    Object localVarPostBody = idList;
    
    // verify the required parameter 'idList' is set
    if (idList == null) {
      throw new ApiException(400, "Missing the required parameter 'idList' when calling deleteDadesGrupsUsingPOST");
    }
    
    // create path and map variables
    String localVarPath = "/procediments/dadesGrups/delete";
