...
@Component("es.bcn.gpa.gpaserveis.rest.client.api.gpaprocediments.ProcedimentsRequerimentsOperatiusApi")
public class ProcedimentsRequerimentsOperatiusApi {
     ...
     */
    public RestClientResponse updateRequerimentsOperatiusUsingPOST(ProcedimentsRDTO procedimentsRDTO) throws RestClientException {
        Object postBody = procedimentsRDTO;
        
        // verify the required parameter 'procedimentsRDTO' is set
        if (procedimentsRDTO == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'procedimentsRDTO' when calling updateRequerimentsOperatiusUsingPOST");
        }
        
        String path = UriComponentsBuilder.fromPath("/procediments/requerimentsOperatius").build().toUriString();
