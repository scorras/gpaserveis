...
@Component("es.bcn.gpa.gpaserveis.rest.client.api.gpaprocediments.NivellIntegracioApi")
public class NivellIntegracioApi {
     ...
     */
    public List<NivellIntegracioRDTO> getNivellIntegracioUsingGET() throws RestClientException {
        Object postBody = null;
        
        String path = UriComponentsBuilder.fromPath("/procediments/catalog/nivellsIntegracio").build().toUriString();
        ...
        ParameterizedTypeReference<List<NivellIntegracioRDTO>> returnType = new ParameterizedTypeReference<List<NivellIntegracioRDTO>>() {};
