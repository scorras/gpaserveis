...
@Component("es.bcn.gpa.gpaserveis.rest.client.api.gpaprocediments.TipusCampsApi")
public class TipusCampsApi {
     ...
     */
    public List<TipusCampsRDTO> getTipusCampsUsingGET() throws RestClientException {
        Object postBody = null;
        
        String path = UriComponentsBuilder.fromPath("/procediments/catalog/tipusCamps").build().toUriString();
        ...
        ParameterizedTypeReference<List<TipusCampsRDTO>> returnType = new ParameterizedTypeReference<List<TipusCampsRDTO>>() {};
