...
public class ProcedimentsApi {
	 ...
	 *            Canals d&#39;activació en format electrònic
	 * @param actuacio
	 *            Actuació
	 * @param aplicacioNegoci
	 *            Nom de l&#39;aplicació de negoci
	 * @param codi
	 *            Codi del procediment
	 * @param competencies
	 *            Competències associades al procediment
	...
	public PageDataOfProcedimentsRDTO cercaProcediments(Integer absoluteRowNumberOfFirstRowInCurrentPage,
	        Integer absoluteRowNumberOfLastRowInCurrentPage, List<String> activableFormatElectronic, String actuacio,
	        String aplicacioNegoci, String codi, List<BigDecimal> competencies, Boolean currentPageHasNextPage,
	        ...
	        String dir, List<BigDecimal> estats, List<BigDecimal> families, BigDecimal id, BigDecimal idUsuari, Integer intern,
	        Integer nextPageNumber, String nom, Integer operador, String organResolutori, Integer pageSize, Integer previousPageNumber,
	        String sort, Long totalElements, Integer totalPages, List<BigDecimal> ugos) throws RestClientException {
		...
		queryParams.putAll(apiClient.parameterToMultiValueMap(ApiClient.CollectionFormat.valueOf("multi".toUpperCase()),
		        "activableFormatElectronic", activableFormatElectronic));
		...
		queryParams.putAll(apiClient.parameterToMultiValueMap(ApiClient.CollectionFormat.valueOf("multi".toUpperCase()), "competencies",
		        competencies));
		...
		queryParams.putAll(
		        apiClient.parameterToMultiValueMap(ApiClient.CollectionFormat.valueOf("multi".toUpperCase()), "families", families));
	...
	public ProcedimentsRDTO consultarDadesProcediment(BigDecimal id) throws RestClientException {
		...
		if (id == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'id' when calling consultarDadesProcediment");
		}
	...
	public ProcedimentsRDTO consultarDadesProcedimentPerCodi(String codi) throws RestClientException {
		...
		if (codi == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'codi' when calling consultarDadesProcedimentPerCodi");
		}
