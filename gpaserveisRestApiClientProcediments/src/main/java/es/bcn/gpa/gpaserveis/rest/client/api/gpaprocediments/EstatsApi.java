...
@Component("es.bcn.gpa.gpaserveis.rest.client.api.gpaprocediments.EstatsApi")
public class EstatsApi {
     ...
     */
    public List<EstatsRDTO> getEstatsUsingGET() throws RestClientException {
        Object postBody = null;
        
        String path = UriComponentsBuilder.fromPath("/procediments/catalog/estats").build().toUriString();
