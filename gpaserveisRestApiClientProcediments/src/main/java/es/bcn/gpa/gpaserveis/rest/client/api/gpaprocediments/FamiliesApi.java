...
@Component("es.bcn.gpa.gpaserveis.rest.client.api.gpaprocediments.FamiliesApi")
public class FamiliesApi {
     ...
     */
    public List<FamiliesRDTO> getFamiliesUsingGET() throws RestClientException {
        Object postBody = null;
        
        String path = UriComponentsBuilder.fromPath("/procediments/catalog/families").build().toUriString();
        ...
        ParameterizedTypeReference<List<FamiliesRDTO>> returnType = new ParameterizedTypeReference<List<FamiliesRDTO>>() {};
