...
import es.bcn.gpa.gpaserveis.rest.client.invoker.gpaprocediments.auth.AuthenticationImpl;
import es.bcn.gpa.gpaserveis.rest.client.invoker.gpaprocediments.auth.HttpBasicAuth;
import es.bcn.gpa.gpaserveis.rest.client.invoker.gpaprocediments.auth.OAuth;
import es.bcn.gpa.gpaserveis.rest.client.invoker.gpaprocediments.exception.handler.ProcedimentsResponseErrorHandler;

@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-08-14T14:00:34.420+02:00")
@Component("es.bcn.gpa.gpaserveis.rest.client.invoker.gpaprocediments.ApiClient")
public class ApiClient {
	...
	private String basePath = "https://localhost/services/gpaprocediments/rest";
