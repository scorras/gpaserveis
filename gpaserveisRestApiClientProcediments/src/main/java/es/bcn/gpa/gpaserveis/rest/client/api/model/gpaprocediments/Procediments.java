...
public class Procediments {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bloqueig, bloquejos, codi, codiNom, comentarisList, configuracioAvisos, configuracioDocumentacio, dadesGrupsList, darreraModificacio, darreraSincronitzacio, descripcio, descripcioCastella, descripcioEstat, descripcioEstatCastella, descripcioEstatCatala, descripcioRelacio, estatProcediment, estatsProcediment, historicsList, id, identificacio, identificacions, iniciacionsList, nom, nomCastella, numerador, pathSerieDocumental, procedimentsAssociatsList, procedimentsRelacionatsList, reqOperatius, requerimentsOperatius, respostaAllegacion, respostaRequeriment, serieDocumental, tramitador, ugosDescripcions, ugosList, ugosNoms, ugosNomsDescripcions, ugrDescripcio, ugrIdext, ugrNom, ugrNomDescripcio, ultimaModificacio, unitat, versio, versioDocumental);
  }
