...
public class NumeradorsApiTest extends ParentTest {
	...
	@InjectMocks
	private NumeradorsApi api = new NumeradorsApi();
	 ...
	 */
	@Test
	public void getSequenceNextValUsingGETTest() throws ApiException {
		when(apiClient.escapeString(any(String.class))).thenReturn(ONE.toString());
		when(apiClient.invokeAPI(eq("/procediments/sequenceNextVal/1"), eq("GET"), any(List.class), any(Object.class), any(Map.class),
		        any(Map.class), any(String.class), any(String.class), any(String[].class), any(GenericType.class)))
		                .thenReturn(new String());

		BigDecimal idProcediment = ONE;
		String response = api.getSequenceNextValUsingGET(idProcediment);
