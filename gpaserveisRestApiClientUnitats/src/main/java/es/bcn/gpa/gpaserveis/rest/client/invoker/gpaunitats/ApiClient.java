...
import es.bcn.gpa.gpaserveis.rest.client.invoker.gpaunitats.auth.ApiKeyAuth;
import es.bcn.gpa.gpaserveis.rest.client.invoker.gpaunitats.auth.Authentication;
import es.bcn.gpa.gpaserveis.rest.client.invoker.gpaunitats.auth.AuthenticationImpl;
import es.bcn.gpa.gpaserveis.rest.client.invoker.gpaunitats.auth.HttpBasicAuth;
import es.bcn.gpa.gpaserveis.rest.client.invoker.gpaunitats.auth.OAuth;
import es.bcn.gpa.gpaserveis.rest.client.invoker.gpaunitats.exception.handler.UnitatsResponseErrorHandler;

@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-08-14T14:06:00.377+02:00")
@Component("es.bcn.gpa.gpaserveis.rest.client.invoker.gpaunitats.ApiClient")
public class ApiClient {
	...
	private String basePath = "https://localhost/services/gpaunitats/rest";
	 ...
	 * 
	 * @return boolean true if this client is enabled for debugging, false
	 *         otherwise
	 */
	...
	protected RestTemplate buildRestTemplate() {
		...
		restTemplate.setErrorHandler(new UnitatsResponseErrorHandler());
		return restTemplate;
	}

	/**
	 * return de RestTemplate
	 * 
	 * @return
	 */
