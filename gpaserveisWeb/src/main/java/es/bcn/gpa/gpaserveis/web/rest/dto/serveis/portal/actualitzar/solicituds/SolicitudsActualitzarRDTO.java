...
import es.bcn.gpa.gpaserveis.web.rest.dto.serveis.portal.crear.solicituds.UnitatGestoraSolicitudsCrearRDTO;
...
@JsonPropertyOrder({ "procediment", "unitatGestora", "sollicitant", "representant", "solicitant", "representant", "documents", "atributs" })
@Getter
@Setter
