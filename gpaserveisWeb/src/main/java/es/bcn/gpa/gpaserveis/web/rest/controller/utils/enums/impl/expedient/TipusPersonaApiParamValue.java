...
/**
 * The Enum TipusPersonaApiParamValue.
 */
public enum TipusPersonaApiParamValue implements BaseApiParamValue {

    /** The en preparacio. */
	FISICA("FISICA", new BigDecimal(1)),

	/** The sol licitud en revisio. */
	JURIDICA("JURIDICA", new BigDecimal(2));
	 ...
	 *            the internal value
	 */
	TipusPersonaApiParamValue(String apiParamValue, BigDecimal internalValue) {
