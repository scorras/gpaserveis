...
public class ServeisPortaSignaturesRestController extends BaseRestController {
	...
	/**
	 * Servei específic que invocarà portasignatures per informar de l'estat de les peticions.
     *
	 * @return void
	 */
	...
	public MciPortasigResultatPeticioRespostaDTO resultatEstatPeticio(
		...
		if (log.isDebugEnabled()) {
			log.debug("resultatPeticio(MciPortasigResultatPeticioDTO) - inici"); //$NON-NLS-1$
