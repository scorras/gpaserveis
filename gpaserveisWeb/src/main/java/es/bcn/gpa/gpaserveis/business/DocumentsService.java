...
public interface DocumentsService {
	 ...
	 *             the GPA serveis service exception
	 */
	List<DocsTramitacioRDTO> cercaDocumentsTramitacio(BigDecimal idDocumentacio, BigDecimal visibilitat) throws GPAServeisServiceException;
