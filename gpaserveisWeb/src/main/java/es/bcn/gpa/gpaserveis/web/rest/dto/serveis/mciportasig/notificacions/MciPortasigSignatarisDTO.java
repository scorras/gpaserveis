...
@JsonPropertyOrder({ "codiUsuari", "nifUsuari", "nomCompletUsuari", "tipusPeticio", "tipusDocument", "ordreIntervencio", "esObligada", "dataCaducitat", "codiEstat", "raoRetorn", "ticketSignatura", "carrec", "tractament", "instantSignatura" })
@Getter
@Setter
public class MciPortasigSignatarisDTO {
	...
	private short ordreIntervencio;
	...
	private String ticketSignatura;
