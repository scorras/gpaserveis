...
public class RespostaEvidenciaDigitalitzacioECompulsaRDTO {
	...
	@ApiModelProperty(value = "\"OK\" si l'escaneig s'ha realitzat correctament o \"KO\" en cas contrari.", allowableValues = EstatDigitalitzacioApiParamValueTranslator.REQUEST_PARAM_ALLOWABLE_VALUES)
