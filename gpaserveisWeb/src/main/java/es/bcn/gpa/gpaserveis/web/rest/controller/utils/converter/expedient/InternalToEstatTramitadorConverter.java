...
/**
 * The Class InternalToEstatTramitadorConverter.
 */
@Component("expedientInternalToEstatTramitadorConverter")
public class InternalToEstatTramitadorConverter extends AbstractConverter<BigDecimal, String> {
	...
	protected String convert(BigDecimal source) {
		return expedientEstatTramitadorApiParamValueTranslator.getApiParamValueByInternalValue(source);
	}
}