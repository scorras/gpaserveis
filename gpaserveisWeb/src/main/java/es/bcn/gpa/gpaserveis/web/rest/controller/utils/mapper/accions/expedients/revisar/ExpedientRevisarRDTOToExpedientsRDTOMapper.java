...
/**
 * The Class ExpedientRevisarRDTOToExpedientsRDTOMapper.
 */
@Component("expedientRevisarRDTOToExpedientsRDTOMapper")
public class ExpedientRevisarRDTOToExpedientsRDTOMapper extends PropertyMap<ExpedientRevisarRDTO, ExpedientsRDTO> {
	 ...
	 */
	@Autowired
	public ExpedientRevisarRDTOToExpedientsRDTOMapper(
	...
	protected void configure() {
		...
		using(tipusIniciacioSollicitudToInternalConverter).map(source.getIniciacio()).setIniciacio(null);
	}
