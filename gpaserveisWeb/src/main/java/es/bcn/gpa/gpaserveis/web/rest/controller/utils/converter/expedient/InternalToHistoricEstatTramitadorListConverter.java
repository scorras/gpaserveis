 ...
 */
@Component("expedientInternalToHistoricEstatTramitadorListConverter")
public class InternalToHistoricEstatTramitadorListConverter extends AbstractConverter<List<EstatsRDTO>, List<HistoricsRDTO>> {
	...
	protected List<HistoricsRDTO> convert(List<EstatsRDTO> source) {
		...
		if (CollectionUtils.isNotEmpty(source)) {
			...
			for (EstatsRDTO estatsRDTO : source) {
				historicsRDTOList.add(ConverterHelper.buildHistoricsTramitadorsRDTOExpedient(estatsRDTO));
			}
