...
/**
 * The Class ExpedientActualitzarRDTOToExpedientsRDTOPortalMapper.
 */
@Component("expedientActualitzarRDTOToExpedientsRDTOPortalMapper")
public class ExpedientActualitzarRDTOToExpedientsRDTOPortalMapper extends PropertyMap<ExpedientActualitzarRDTO, ExpedientsRDTO> {
	 ...
	 *            the persona representant to internal converter
	 * @param listPersonesInteressadesToListInternalConverter
	 *            the list persones interessades to list internal converter
	 * @param listPersonesImplicadesToListInternalConverter
	 *            the list persones implicades to list internal converter
	 */
	@Autowired
	public ExpedientActualitzarRDTOToExpedientsRDTOPortalMapper(
