...
/**
 * The Class PersonaPersonesImplicadesToInternalConverter.
 */
@Component("expedientListPersonesImplicadesToListInternalConverter")
public class ListPersonesImplicadesToListInternalConverter extends AbstractConverter<List<PersonesRDTO>, List<PersonesSollicitud>> {
