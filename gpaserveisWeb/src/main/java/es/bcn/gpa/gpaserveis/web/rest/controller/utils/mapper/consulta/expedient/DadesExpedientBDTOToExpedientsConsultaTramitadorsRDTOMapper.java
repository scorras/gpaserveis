...
import es.bcn.gpa.gpaserveis.web.rest.controller.utils.converter.document.InternalToDocumentGeneratConsultaListConverter;
...
import es.bcn.gpa.gpaserveis.web.rest.controller.utils.converter.expedient.InternalToHistoricEstatTramitadorListConverter;
...
/**
 * The Class DadesExpedientBDTOToExpedientsConsultaTramitadorsRDTOMapper.
 */
@Component
public class DadesExpedientBDTOToExpedientsConsultaTramitadorsRDTOMapper
		extends PropertyMap<DadesExpedientBDTO, ExpedientConsultaTramitadorsRDTO> {
	...
	/** The internal to historic estat tramitador list converter. */
	private InternalToHistoricEstatTramitadorListConverter internalToHistoricEstatTramitadorListConverter;
	...
	/** The internal to document generat consulta list converter. */
	private InternalToDocumentGeneratConsultaListConverter internalToDocumentGeneratConsultaListConverter;
	 ...
	 *            the internal to documents entrada requerits list converter
	 * @param internalToDocumentGeneratConsultaListConverter
	 *            the internal to document generat consulta list converter
	 ...
	 */
	@Autowired
	public DadesExpedientBDTOToExpedientsConsultaTramitadorsRDTOMapper(
			...
			@Qualifier("expedientInternalToHistoricEstatTramitadorListConverter") InternalToHistoricEstatTramitadorListConverter internalToHistoricEstatTramitadorListConverter,
			...
			@Qualifier("internalToDocumentGeneratConsultaListConverter") InternalToDocumentGeneratConsultaListConverter internalToDocumentGeneratConsultaListConverter,
		...
		this.internalToHistoricEstatTramitadorListConverter = internalToHistoricEstatTramitadorListConverter;
		...
		this.internalToDocumentGeneratConsultaListConverter = internalToDocumentGeneratConsultaListConverter;
	...
	protected void configure() {
		...
		using(internalToHistoricEstatTramitadorListConverter).map(source.getHistoricsEstats()).setHistorics(null);
		...
		using(internalToDocumentGeneratConsultaListConverter).map(source.getDocumentsGenerats()).setDocumentsGenerats(null);
