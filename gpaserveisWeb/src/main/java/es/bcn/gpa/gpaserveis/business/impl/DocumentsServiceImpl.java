...
public class DocumentsServiceImpl implements DocumentsService {
	...
	public DocsEntradaRDTO fallbackGuardarDocumentEntradaFitxer(GuardarDocumentEntradaFitxerBDTO guardarDocumentEntradaFitxerBDTO,
		...
		throw new GPAServeisServiceException("El servei de documentacio no està disponible", e);
	}
	 ...
	 *             the GPA serveis service exception
	 */
	public void fallbackSignarValidarDocument(SignarDocument signarDocument) throws GPAServeisServiceException {
		if (log.isDebugEnabled()) {
