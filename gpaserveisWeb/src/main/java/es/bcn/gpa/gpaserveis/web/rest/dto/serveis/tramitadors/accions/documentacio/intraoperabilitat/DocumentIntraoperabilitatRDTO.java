package es.bcn.gpa.gpaserveis.web.rest.dto.serveis.tramitadors.accions.documentacio.intraoperabilitat;
...
@JsonPropertyOrder({ "configuracio", "configuracioDocumentacio", "origen", "comentari", "idioma", "revisio", "digitalitzat",
		"digitalitzacio", "numeroRegistre" })
@Getter
@Setter
public class DocumentIntraoperabilitatRDTO {
	@ApiModelProperty(value = "Configuració del document.", required = true, allowableValues = "APORTADA")
