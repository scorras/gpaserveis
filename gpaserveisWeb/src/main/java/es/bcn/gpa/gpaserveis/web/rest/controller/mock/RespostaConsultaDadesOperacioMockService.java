...
public class RespostaConsultaDadesOperacioMockService {
		...
		dadesOperacio.setGrups( 
			Arrays.asList(
				DadesGrupsRDTOFactory.create("Grup 1", "2", "1", null, null, 
					Arrays.asList(
							DadesAtributsRDTOFactory.create("ATTR1", "Atribut 1", "1", "OBLIGATORI", "TEXT", null, null),
	...
	private static class DadesAtributsRDTOFactory {
		...
		private static DadesAtributsRDTO create(
				String codi,
				String descripcio,
				String ordre,
				String validacions,
	...
	private static class DadesGrupsRDTOFactory {
		...
		private static DadesGrupsRDTO create(
				String descripcio,
				String columnes,
				String ordre,
				String urlValidacio,
