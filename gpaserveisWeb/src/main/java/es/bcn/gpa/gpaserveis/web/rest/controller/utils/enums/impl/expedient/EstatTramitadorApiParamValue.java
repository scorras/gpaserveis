...
/**
 * The Enum EstatTramitadorApiParamValue.
 */
public enum EstatTramitadorApiParamValue implements BaseApiParamValue {
	 ...
	 *            the internal value
	 */
	EstatTramitadorApiParamValue(String apiParamValue, BigDecimal internalValue) {
