...
/**
 * The Class InternalToDocumentEntradaIncorporatNouAccioConverter.
 */
@Component("internalToDocumentEntradaIncorporatNouAccioConverter")
public class InternalToDocumentEntradaIncorporatNouAccioConverter
        extends AbstractConverter<DocsEntradaRDTO, DocumentIncorporatNouAccioRDTO> {
	 ...
	 */
	@Override
	protected DocumentIncorporatNouAccioRDTO convert(DocsEntradaRDTO docsEntradaRDTO) {
		return ConverterHelper.buildDocumentIncorporatNouAccioRDTOExpedient(docsEntradaRDTO, origenApiParamValueTranslator,
