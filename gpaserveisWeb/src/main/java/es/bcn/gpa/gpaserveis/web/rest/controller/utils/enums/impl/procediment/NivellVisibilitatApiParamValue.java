...
/**
 * The Enum NivellVisibilitatApiParamValue.
 */
public enum NivellVisibilitatApiParamValue implements BaseApiParamValue {

	/** The alta. */
	ALTA("ALTA", new BigDecimal(1)),

	/** The baixa. */
	BAIXA("BAIXA", new BigDecimal(2)),

	/** The Nul·la. */
	NULLA("NUL·LA", new BigDecimal(3));
	 ...
	 *            the internal value
	 */
	NivellVisibilitatApiParamValue(String apiParamValue, BigDecimal internalValue) {
