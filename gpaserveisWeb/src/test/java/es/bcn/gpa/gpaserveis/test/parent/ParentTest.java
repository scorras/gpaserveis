...
public abstract class ParentTest {
	...
	public void setUp() {
		...
		try {
			...
			when(documentacioApi.saveDocumentacioTramitacio(any(DocsTramitacioRDTO.class), any(BigDecimal.class)))
					.thenReturn(TestsConfigHelper.saveDocumentacioTramitacioResponse());
