...
public class RetornarLaTramitacioApiTest extends ParentTest {

	@InjectMocks
	private RetornarLaTramitacioApi api = new RetornarLaTramitacioApi();
	...
	public void retornarTramitacioExpedientTest() {
		when(apiClient.invokeAPI(eq("/expedients/retornarLaTramitacio"), eq(HttpMethod.POST), any(MultiValueMap.class), any(Object.class),
