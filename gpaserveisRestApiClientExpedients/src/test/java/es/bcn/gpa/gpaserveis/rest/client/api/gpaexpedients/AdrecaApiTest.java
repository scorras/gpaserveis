...
public class AdrecaApiTest extends ParentTest {

	@InjectMocks
	private AdrecaApi api = new AdrecaApi();
	...
	public void normalitzarAdrecaPostalUsingGETTest() throws ApiException {
		...
		when(apiClient.invokeAPI(eq("/expedients/catalog/normalitzarAdrecaPostal/1/1"), eq("GET"), any(List.class), any(Object.class),
		        any(Map.class), any(Map.class), any(String.class), any(String.class), any(String[].class), any(GenericType.class)))
		                .thenReturn(new AdrecaNormalitzadaRDTO());

		String nomVia = ONE.toString();
		String numero = ONE.toString();
