...
public class MunicipisApiTest extends ParentTest {

	@InjectMocks
	private MunicipisApi api = new MunicipisApi();
	...
	public void getMunicipisByProvinciaUsingGETTest() throws ApiException {
		...
		List<MunicipisRDTO> response = api.getMunicipisByProvinciaUsingGET(idProvincia);
