...
public class AvisosApi {
	 ...
	 */
	public void crearAvisAccio(BigDecimal idAccio, BigDecimal idExpedient, AvisCreacioAccio avisCreacioAccioRDTO)
	        throws RestClientException {
		...
		if (idAccio == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'idAccio' when calling crearAvisAccio");
		}

		// verify the required parameter 'idExpedient' is set
		if (idExpedient == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'idExpedient' when calling crearAvisAccio");
		}
		...
		String path = UriComponentsBuilder.fromPath("/avisos/{idExpedient}/accions/{idAccio}/crear").buildAndExpand(uriVariables)
		        .toUriString();
