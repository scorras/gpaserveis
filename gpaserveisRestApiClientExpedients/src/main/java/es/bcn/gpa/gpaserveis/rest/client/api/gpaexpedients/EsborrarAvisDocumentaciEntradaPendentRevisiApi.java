...
public class EsborrarAvisDocumentaciEntradaPendentRevisiApi {
	 ...
	 * 
	 * @param esborrarAvisDocEntradaPendentRevisioRDTO
	 *            esborrarAvisDocEntradaPendentRevisioRDTO (required)
	 * @throws ApiException
	 *             if fails to make API call
	 */
	public void esborrarAvisDocEntradaPendentRevisioUsingPOST(EsborrarAvisDocEntradaPendentRevisio esborrarAvisDocEntradaPendentRevisioRDTO)
	        throws ApiException {
		Object localVarPostBody = esborrarAvisDocEntradaPendentRevisioRDTO;

		// verify the required parameter
		// 'esborrarAvisDocEntradaPendentRevisioRDTO' is set
		if (esborrarAvisDocEntradaPendentRevisioRDTO == null) {
			throw new ApiException(400,
			        "Missing the required parameter 'esborrarAvisDocEntradaPendentRevisioRDTO' when calling esborrarAvisDocEntradaPendentRevisioUsingPOST");
		}
