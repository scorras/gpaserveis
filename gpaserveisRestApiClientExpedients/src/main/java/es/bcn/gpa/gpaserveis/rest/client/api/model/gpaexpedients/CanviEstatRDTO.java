...
public class CanviEstatRDTO {
	...
	@Override
	public int hashCode() {
		return Objects.hash(canviUnitatGestora, comentari, convidarTramitar, estatActual, estatAnterior, estatFuturo, idExpedientsList,
		        respostaAllegacion, respostaRequeriment, transicionsPosibles);
	}
