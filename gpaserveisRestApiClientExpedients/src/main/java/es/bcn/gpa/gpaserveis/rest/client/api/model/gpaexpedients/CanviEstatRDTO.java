...
import es.bcn.gpa.gpaserveis.rest.client.api.model.gpaexpedients.CanviUnitatGestoraMassiuBDTO;
import es.bcn.gpa.gpaserveis.rest.client.api.model.gpaexpedients.Comentaris;
import es.bcn.gpa.gpaserveis.rest.client.api.model.gpaexpedients.ConvidarTramitarMassiuBDTO;
...
public class CanviEstatRDTO {
  @JsonProperty("canviUnitatGestoraMassiu")
  private CanviUnitatGestoraMassiuBDTO canviUnitatGestoraMassiu = null;

  @JsonProperty("comentari")
  private Comentaris comentari = null;

  @JsonProperty("convidarTramitarMassiu")
  private ConvidarTramitarMassiuBDTO convidarTramitarMassiu = null;
  ...
  public CanviEstatRDTO canviUnitatGestoraMassiu(CanviUnitatGestoraMassiuBDTO canviUnitatGestoraMassiu) {
    this.canviUnitatGestoraMassiu = canviUnitatGestoraMassiu;
    return this;
  }

   /**
   * Get canviUnitatGestoraMassiu
   * @return canviUnitatGestoraMassiu
  **/
  @ApiModelProperty(value = "")
  public CanviUnitatGestoraMassiuBDTO getCanviUnitatGestoraMassiu() {
    return canviUnitatGestoraMassiu;
  }

  public void setCanviUnitatGestoraMassiu(CanviUnitatGestoraMassiuBDTO canviUnitatGestoraMassiu) {
    this.canviUnitatGestoraMassiu = canviUnitatGestoraMassiu;
  }
  ...
  **/
  ...
  public CanviEstatRDTO convidarTramitarMassiu(ConvidarTramitarMassiuBDTO convidarTramitarMassiu) {
    this.convidarTramitarMassiu = convidarTramitarMassiu;
    return this;
  }

   /**
   * Get convidarTramitarMassiu
   * @return convidarTramitarMassiu
  **/
  @ApiModelProperty(value = "")
  public ConvidarTramitarMassiuBDTO getConvidarTramitarMassiu() {
    return convidarTramitarMassiu;
  }

  public void setConvidarTramitarMassiu(ConvidarTramitarMassiuBDTO convidarTramitarMassiu) {
    this.convidarTramitarMassiu = convidarTramitarMassiu;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.canviUnitatGestoraMassiu, canviEstatRDTO.canviUnitatGestoraMassiu) &&
        Objects.equals(this.comentari, canviEstatRDTO.comentari) &&
        Objects.equals(this.convidarTramitarMassiu, canviEstatRDTO.convidarTramitarMassiu) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(canviUnitatGestoraMassiu, comentari, convidarTramitarMassiu, dataLimitAllegacio, dataLimitRequeriment, estatActual, estatAnterior, estatFuturo, idExpedientsList, respostaAllegacion, respostaRequeriment, transicionsPosibles);
  }
  ...
  public String toString() {
    ...
    sb.append("    canviUnitatGestoraMassiu: ").append(toIndentedString(canviUnitatGestoraMassiu)).append("\n");
    sb.append("    comentari: ").append(toIndentedString(comentari)).append("\n");
    sb.append("    convidarTramitarMassiu: ").append(toIndentedString(convidarTramitarMassiu)).append("\n");
