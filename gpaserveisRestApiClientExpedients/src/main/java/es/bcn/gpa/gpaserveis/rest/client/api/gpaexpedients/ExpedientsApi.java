...
public class ExpedientsApi {
	...
	public void bloquejarExpedientUsingPOST(BloquejosRDTO bloquejosRDTO, BigDecimal id) throws ApiException {
		...
		String localVarPath = "/expedients/bloquejar/{id}".replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
	 ...
	 * 
	 * @param idAccio
	 *            Identificador de l&#39;acció (required)
	 * @param idExpedient
	 *            Identificador de l&#39;expedient (required)
	 * @param expedientCanviEstatAccioRDTO
	 *            Dades del canvi d&#39;estat (optional)
	...
	public RespostaCanviarEstatAccioExpedient canviarEstatAccioExpedient(BigDecimal idAccio, BigDecimal idExpedient,
	        ExpedientCanviEstatAccio expedientCanviEstatAccioRDTO) throws ApiException {
	...
	public PageDataOfHistoricsRDTO cercaHistoricsExpedient(BigDecimal id, Integer absoluteRowNumberOfFirstRowInCurrentPage,
	        ...
	        Integer pageSize, Integer previousPageNumber, String sort, List<BigDecimal> tipus, Long totalElements, Integer totalPages)
	        throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/expedients/historic/{id}".replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
	...
	public void desbloquejarExpedientUsingPOST(BigDecimal id) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/expedients/desbloquejar/{id}".replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
	...
	public BloquejosRDTO expedientBloquejatPerUnAltreUsuariUsingGET(BigDecimal id) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/expedients/expedientBloquejatPerUnAltreUsuari/{id}".replaceAll("\\{" + "id" + "\\}",
	...
	public ExpedientOpenTextRDTO getExpedientDataOpenTextUsingGET(BigDecimal id) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/expedients/expedientDataOpenText/{id}".replaceAll("\\{" + "id" + "\\}",
		        apiClient.escapeString(id.toString()));
	...
	public List<HistoricsRDTO> getHistoricsListUsingGET(String ids) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/expedients/historic/list/{ids}".replaceAll("\\{" + "ids" + "\\}", apiClient.escapeString(ids.toString()));
	...
	public List<RegistreAssentamentRDTO> getRegistresAssentamentListUsingGET(String ids) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/expedients/registre/list/{ids}".replaceAll("\\{" + "ids" + "\\}", apiClient.escapeString(ids.toString()));
	...
	public RespostaUnitatsExpedient getUnitasGestoresExpedientUsingGET(BigDecimal idExpedient) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/expedients/unitasExpedient/{idExpedient}".replaceAll("\\{" + "idExpedient" + "\\}",
	...
	public BigDecimal registrarHistoricDocumentacioUsingPOST(HistoricsRDTO historicsRDTO) throws ApiException {
		...
		if (historicsRDTO == null) {
			throw new ApiException(400,
			        "Missing the required parameter 'historicsRDTO' when calling registrarHistoricDocumentacioUsingPOST");
		}
	 ...
	 *             if fails to make API call
	 */
	public PageDataOfComentarisRDTO searchComentarisUsingGET(BigDecimal id, Integer absoluteRowNumberOfFirstRowInCurrentPage,
	        Integer absoluteRowNumberOfLastRowInCurrentPage, Boolean currentPageHasNextPage, Boolean currentPageHasPreviousPage,
	        Boolean currentPageIsFirstPage, Boolean currentPageIsLastPage, Integer currentPageNumber, String dir, Integer nextPageNumber,
		...
		// create path and map variables
		String localVarPath = "/expedients/comentaris/{id}".replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
