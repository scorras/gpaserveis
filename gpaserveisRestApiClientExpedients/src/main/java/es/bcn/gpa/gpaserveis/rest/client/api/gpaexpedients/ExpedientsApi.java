...
public class ExpedientsApi {
	...
	public void actualitzarExpedient(ExpedientsRDTO expedientsRDTO) throws RestClientException {
		...
		if (expedientsRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'expedientsRDTO' when calling actualitzarExpedient");
		}
	 ...
	 * @param anotarOperacioComptableRDTO
	 *            Dades dades de l&#39;operació comptable
	 * @throws RestClientException
	 *             if an error occurs while attempting to invoke the API
	 */
	public void anotarOperacioComptable(BigDecimal idExpedient, AnotarOperacioComptableRDTO anotarOperacioComptableRDTO)
	        throws RestClientException {
		...
		if (idExpedient == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'idExpedient' when calling anotarOperacioComptable");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idExpedient", idExpedient);
		String path = UriComponentsBuilder.fromPath("/expedients/anotarOperacioComptable/{idExpedient}").buildAndExpand(uriVariables)
		        .toUriString();
	 ...
	 * @param idExpedient
	 *            Identificador de l&#39;expedient
	 * @param expedientCanviEstatRDTO
	 *            Dades del canvi d&#39;estat
	 * @return RespostaCanviarEstatAccioExpedient
	 * @throws RestClientException
	 *             if an error occurs while attempting to invoke the API
	 */
	public RespostaCanviarEstatAccioExpedient canviarEstatExpedient(BigDecimal idExpedient, ExpedientCanviEstat expedientCanviEstatRDTO)
	        throws RestClientException {
		...
		if (idExpedient == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'idExpedient' when calling canviarEstatExpedient");
		}
	 ...
	 *             if an error occurs while attempting to invoke the API
	 */
	public void canviarUnitatGestoraExpedient(CanviUnitatGestoraRDTO canviUnitatGestoraRDTO, BigDecimal idExpedient)
	        throws RestClientException {
		...
		if (canviUnitatGestoraRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'canviUnitatGestoraRDTO' when calling canviarUnitatGestoraExpedient");
		}

		// verify the required parameter 'idExpedient' is set
		if (idExpedient == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'idExpedient' when calling canviarUnitatGestoraExpedient");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idExpedient", idExpedient);
		String path = UriComponentsBuilder.fromPath("/expedients/canviarUnitatGestora/{idExpedient}").buildAndExpand(uriVariables)
		        .toUriString();
	...
	public void convidarTramitarExpedient(ConvidarTramitarRDTO convidarTramitarRDTO, BigDecimal idExpedient) throws RestClientException {
		...
		if (convidarTramitarRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'convidarTramitarRDTO' when calling convidarTramitarExpedient");
		}

		// verify the required parameter 'idExpedient' is set
		if (idExpedient == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'idExpedient' when calling convidarTramitarExpedient");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idExpedient", idExpedient);
		String path = UriComponentsBuilder.fromPath("/expedients/convidarTramitar/{idExpedient}").buildAndExpand(uriVariables)
		        .toUriString();
	...
	public void esborrarRegistreSolicitudExpedient(CrearRegistre registrarSolicitudExpedientRDTO) throws RestClientException {
		...
		if (registrarSolicitudExpedientRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'registrarSolicitudExpedientRDTO' when calling esborrarRegistreSolicitudExpedient");
		}
	 ...
	 * <b>404</b> - Not Found
	 * 
	 * @param registrarSolicitudRDTO
	 *            registrarSolicitudRDTO
	 * @throws RestClientException
	 *             if an error occurs while attempting to invoke the API
	 */
	public void esborrarRegistreSollicitud(CrearSollicitud registrarSolicitudRDTO) throws RestClientException {
		...
		if (registrarSolicitudRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'registrarSolicitudRDTO' when calling esborrarRegistreSollicitud");
		}
	 ...
	 * @param idExpedient
	 *            Identificador de l&#39;expedient
	 * @param inscriureEnRegistreRDTO
	 *            Dades dades del registre
	 * @throws RestClientException
	 *             if an error occurs while attempting to invoke the API
	 */
	public void inscriureEnRegistre(BigDecimal idExpedient, InscriureEnRegistreRDTO inscriureEnRegistreRDTO) throws RestClientException {
		...
		if (idExpedient == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'idExpedient' when calling inscriureEnRegistre");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idExpedient", idExpedient);
		String path = UriComponentsBuilder.fromPath("/expedients/inscriureEnRegistre/{idExpedient}").buildAndExpand(uriVariables)
		        .toUriString();
	 ...
	 * @param idExpedient
	 *            idExpedient
	 * @param obtenirPerInteroperabilitatRDTO
	 *            obtenirPerInteroperabilitatRDTO
	 * @return RespostaInteroperabilitat
	 * @throws RestClientException
	 *             if an error occurs while attempting to invoke the API
	 */
	public RespostaInteroperabilitat obtenirPerInteroperabilitat(BigDecimal idExpedient,
	        ObtenirPerInteroperabilitat obtenirPerInteroperabilitatRDTO) throws RestClientException {
		Object postBody = obtenirPerInteroperabilitatRDTO;

		// verify the required parameter 'idExpedient' is set
		if (idExpedient == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'idExpedient' when calling obtenirPerInteroperabilitat");
		}

		// verify the required parameter 'obtenirPerInteroperabilitatRDTO' is
		// set
		if (obtenirPerInteroperabilitatRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'obtenirPerInteroperabilitatRDTO' when calling obtenirPerInteroperabilitat");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idExpedient", idExpedient);
		String path = UriComponentsBuilder.fromPath("/expedients/obtenirPerInteroperabilitat/{idExpedient}").buildAndExpand(uriVariables)
		        .toUriString();
	 ...
	 * <b>404</b> - Not Found
	 * 
	 * @param redireccioAssentamentRDTO
	 *            redireccioAssentamentRDTO
	 * @throws RestClientException
	 *             if an error occurs while attempting to invoke the API
	 */
	public void redireccionarRegistre(RedireccioAssentament redireccioAssentamentRDTO) throws RestClientException {
		...
		if (redireccioAssentamentRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'redireccioAssentamentRDTO' when calling redireccionarRegistre");
		}
	 ...
	 * @param idExpedient
	 *            Identificador de l&#39;expedient
	 * @param retornarTramitacioRDTO
	 *            retornarTramitacioRDTO
	 * @return RetornTramitacio
	 * @throws RestClientException
	 *             if an error occurs while attempting to invoke the API
	 */
	public RetornTramitacio retornarTramitacioExpedient(BigDecimal idExpedient, RetornarTramitacioRDTO retornarTramitacioRDTO)
	        throws RestClientException {
		...
		if (idExpedient == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'idExpedient' when calling retornarTramitacioExpedient");
		}

		// verify the required parameter 'retornarTramitacioRDTO' is set
		if (retornarTramitacioRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'retornarTramitacioRDTO' when calling retornarTramitacioExpedient");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idExpedient", idExpedient);
		String path = UriComponentsBuilder.fromPath("/expedients/retornarTramitacio/{idExpedient}").buildAndExpand(uriVariables)
		        .toUriString();
	 ...
	 * @param idExpedient
	 *            Identificador de l&#39;expedient
	 * @param tornarEnrereRDTO
	 *            Dades de tornar enrere
	 * @throws RestClientException
	 *             if an error occurs while attempting to invoke the API
	 */
	public void tornarEnrere(BigDecimal idExpedient, TornarEnrereRDTO tornarEnrereRDTO) throws RestClientException {
		...
		if (idExpedient == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'idExpedient' when calling tornarEnrere");
		}
	...
	public void reprendreTramitacio(BigDecimal idExpedient) throws RestClientException {
		...
		if (idExpedient == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'idExpedient' when calling reprendreTramitacio");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idExpedient", idExpedient);
		String path = UriComponentsBuilder.fromPath("/expedients/{idExpedient}/reprendreTramitacio").buildAndExpand(uriVariables)
		        .toUriString();
