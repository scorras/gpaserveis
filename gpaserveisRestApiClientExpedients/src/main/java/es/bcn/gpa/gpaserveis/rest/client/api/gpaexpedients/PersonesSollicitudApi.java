...
public class PersonesSollicitudApi {
	 ...
	 * 
	 * @param personesSollicitudRDTOList
	 *            personesSollicitudRDTOList (required)
	 ...
	 */
	public PageDataOfPersonesSollicitudRDTO deleteAltresImplicadesListUsingPOST(List<PersonesSollicitudRDTO> personesSollicitudRDTOList,
		...
		if (personesSollicitudRDTOList == null) {
			throw new ApiException(400,
			        "Missing the required parameter 'personesSollicitudRDTOList' when calling deleteAltresImplicadesListUsingPOST");
		}
	 ...
	 *             if fails to make API call
	 */
	public PageDataOfPersonesSollicitudRDTO deletePersonesInteresadesListUsingPOST(List<PersonesSollicitudRDTO> personesSollicitudRDTOList,
	        Integer absoluteRowNumberOfFirstRowInCurrentPage, Integer absoluteRowNumberOfLastRowInCurrentPage,
	        Boolean currentPageHasNextPage, Boolean currentPageHasPreviousPage, Boolean currentPageIsFirstPage,
	        Boolean currentPageIsLastPage, Integer currentPageNumber, String dir, Integer nextPageNumber, Integer pageSize,
	        Integer previousPageNumber, String sort, Long totalElements, Integer totalPages) throws ApiException {
		...
		if (personesSollicitudRDTOList == null) {
			throw new ApiException(400,
			        "Missing the required parameter 'personesSollicitudRDTOList' when calling deletePersonesInteresadesListUsingPOST");
		}
	 ...
	 *            personesSollicitudRDTO (required)
	 * @param absoluteRowNumberOfFirstRowInCurrentPage
	 *            (optional)
	 * @param absoluteRowNumberOfLastRowInCurrentPage
	 *            (optional)
	 ...
	 *             if fails to make API call
	 */
	public PageDataOfPersonesSollicitudRDTO saveAltresImplicadesUsingPOST(PersonesSollicitudRDTO personesSollicitudRDTO,
	        Integer absoluteRowNumberOfFirstRowInCurrentPage, Integer absoluteRowNumberOfLastRowInCurrentPage,
	        Boolean currentPageHasNextPage, Boolean currentPageHasPreviousPage, Boolean currentPageIsFirstPage,
	        Boolean currentPageIsLastPage, Integer currentPageNumber, String dir, Integer nextPageNumber, Integer pageSize,
	        Integer previousPageNumber, String sort, Long totalElements, Integer totalPages) throws ApiException {
		...
		if (personesSollicitudRDTO == null) {
			throw new ApiException(400,
			        "Missing the required parameter 'personesSollicitudRDTO' when calling saveAltresImplicadesUsingPOST");
		}
	 ...
	 *             if fails to make API call
	 */
	public PageDataOfPersonesSollicitudRDTO savePersonesInteresadesUsingPOST(PersonesSollicitudRDTO personesSollicitudRDTO,
	        Integer absoluteRowNumberOfFirstRowInCurrentPage, Integer absoluteRowNumberOfLastRowInCurrentPage,
	        Boolean currentPageHasNextPage, Boolean currentPageHasPreviousPage, Boolean currentPageIsFirstPage,
	        Boolean currentPageIsLastPage, Integer currentPageNumber, String dir, Integer nextPageNumber, Integer pageSize,
	        Integer previousPageNumber, String sort, Long totalElements, Integer totalPages) throws ApiException {
		...
		if (personesSollicitudRDTO == null) {
			throw new ApiException(400,
			        "Missing the required parameter 'personesSollicitudRDTO' when calling savePersonesInteresadesUsingPOST");
		}
