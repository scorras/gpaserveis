...
import es.bcn.gpa.gpaserveis.rest.client.api.model.gpaexpedients.EsborrarPersonaSollicitudMassiu;
import es.bcn.gpa.gpaserveis.rest.client.api.model.gpaexpedients.PageDataOfPersonesSollicitudRDTO;
import es.bcn.gpa.gpaserveis.rest.client.api.model.gpaexpedients.PersonesSollicitudRDTO;
import es.bcn.gpa.gpaserveis.rest.client.api.model.gpaexpedients.RespostaEsborrarPersonaSollicitudMassiu;
...
public class PersonesSollicitudApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void esborrarPersonaSollicitud(Integer idPersonesSollicitud) throws RestClientException {
    ...
    /**
     * Delete all selected persones sollicitud
     * 
     * <p><b>200</b> - OK
     * <p><b>201</b> - Created
     * <p><b>401</b> - Unauthorized
     * <p><b>403</b> - Forbidden
     * <p><b>404</b> - Not Found
     * @param esborrarPersonaSollicitudMassiuRDTO esborrarPersonaSollicitudMassiuRDTO
     * @param idExpedient idExpedient
     * @return RespostaEsborrarPersonaSollicitudMassiu
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public RespostaEsborrarPersonaSollicitudMassiu esborrarPersonaSollicitudMassiuUsingPOST(EsborrarPersonaSollicitudMassiu esborrarPersonaSollicitudMassiuRDTO, Integer idExpedient) throws RestClientException {
        Object postBody = esborrarPersonaSollicitudMassiuRDTO;
        
        // verify the required parameter 'esborrarPersonaSollicitudMassiuRDTO' is set
        if (esborrarPersonaSollicitudMassiuRDTO == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'esborrarPersonaSollicitudMassiuRDTO' when calling esborrarPersonaSollicitudMassiuUsingPOST");
        }
        
        // verify the required parameter 'idExpedient' is set
        if (idExpedient == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'idExpedient' when calling esborrarPersonaSollicitudMassiuUsingPOST");
        }
        
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("idExpedient", idExpedient);
        String path = UriComponentsBuilder.fromPath("/expedients/personesSollicitud/esborrarPersonaSollicitudMassiu/{idExpedient}").buildAndExpand(uriVariables).toUriString();
        ...
        ParameterizedTypeReference<RespostaEsborrarPersonaSollicitudMassiu> returnType = new ParameterizedTypeReference<RespostaEsborrarPersonaSollicitudMassiu>() {};
        return apiClient.invokeAPI(path, HttpMethod.POST, queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
    }
    /**
     * Save the provided persone
