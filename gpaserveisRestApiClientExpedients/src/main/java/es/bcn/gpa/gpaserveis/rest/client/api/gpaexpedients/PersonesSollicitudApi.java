...
public class PersonesSollicitudApi {
	...
	public PageDataOfPersonesSollicitudRDTO donarAccesAltraPersonaImplicada(PersonesSollicitudRDTO personesSollicitudRDTO,
		...
		if (personesSollicitudRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'personesSollicitudRDTO' when calling donarAccesAltraPersonaImplicada");
		}
	...
	public void esborrarPersonaSollicitud(BigDecimal idPersonesSollicitud) throws RestClientException {
		...
		if (idPersonesSollicitud == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'idPersonesSollicitud' when calling esborrarPersonaSollicitud");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idPersonesSollicitud", idPersonesSollicitud);
		String path = UriComponentsBuilder.fromPath("/expedients/personesSollicitud/{idPersonesSollicitud}").buildAndExpand(uriVariables)
				.toUriString();
	...
	public PersonesSollicitudRDTO incorporarTerceraPersona(PersonesSollicitudRDTO personesSollicitudRDTO) throws RestClientException {
		...
		if (personesSollicitudRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'personesSollicitudRDTO' when calling incorporarTerceraPersona");
		}
