...
public class PersonesDadescontacte {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bloc, codiPostal, direccioPostal, email, escala, fax, id, mobil, municipi, municipiEstranger, municipiValor, numero, pais, paisValor, pis, porta, provincia, provinciaEstranger, provinciaValor, telefon, tipusVia);
  }
