...
public class ExpedientsRDTO {
	...
	public int hashCode() {
		return Objects.hash(accioEstatIdext, aplicacioNegoci, bloqueig, bloquejos, codi, codiLlarg, configuracioDocumentacioProc,
				...
				estatActual, expedientObjecteDeRecursId, id, idEstat, idRelacionat, isOge, nomDescUGConvidada, nomDescUnitatGestora,
				nomProcediment, nomProcedimentCastella, numeroDocumentSollicitant, numeroDocumentSollicitantEstricte, procedimentCodi,
				procedimentIdext, procedimentVersio, relacioTipusRelacio, representantPrincipal, seleccionable, sollicitant,
				sollicitantPrincipal, sollicitud, sollicituds, tipusAvis, tramitador, ugConvidadaIdext, ultimaModificacio,
				unitatGestoraIdext);
	}
