...
public class MunicipisApi {
	...
	public List<MunicipisRDTO> getMunicipisByProvinciaUsingGET(String codiProvincia) throws ApiException {
		...
		String localVarPath = "/expedients/catalog/municipis/{codiProvincia}".replaceAll("\\{" + "codiProvincia" + "\\}",
		        apiClient.escapeString(codiProvincia.toString()));
