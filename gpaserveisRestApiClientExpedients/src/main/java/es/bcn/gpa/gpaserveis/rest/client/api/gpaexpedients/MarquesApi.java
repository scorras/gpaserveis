...
public class MarquesApi {
	...
	public PageDataOfMarquesRDTO cercaMarques(Integer absoluteRowNumberOfFirstRowInCurrentPage,
	        ...
	        String descripcio, String dir, String example, String expressio, BigDecimal id, Integer nextPageNumber, Integer pageSize,
	        Integer previousPageNumber, String referencia, String sort, Long totalElements, Integer totalPages) throws ApiException {
	 ...
	 *             if fails to make API call
	 */
	public PageDataOfMarquesRDTO marquesAdministrador(Integer absoluteRowNumberOfFirstRowInCurrentPage,
