...
public class MarquesApi {
     ...
     */
    public MarquesRDTO afegirMarquesUsingPOST(MarquesRDTO marquesRDTO) throws RestClientException {
        Object postBody = marquesRDTO;
        
        // verify the required parameter 'marquesRDTO' is set
        if (marquesRDTO == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'marquesRDTO' when calling afegirMarquesUsingPOST");
        }
        
        String path = UriComponentsBuilder.fromPath("/marques/afegirMarques").build().toUriString();
     ...
     * <p><b>403</b> - Forbidden
     * <p><b>404</b> - Not Found
     * @param marquesIdList marquesIdList
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void esborrarMarquesUsingPOST(List<BigDecimal> marquesIdList) throws RestClientException {
        Object postBody = marquesIdList;
        
        // verify the required parameter 'marquesIdList' is set
        if (marquesIdList == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'marquesIdList' when calling esborrarMarquesUsingPOST");
        }
        
        String path = UriComponentsBuilder.fromPath("/marques/esborrarMarques").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<DropdownCampReferenciaRDTO> obtenirCampsReferenciaUsingGET() throws RestClientException {
