...
public class DadesEspecifiquesApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<DadesEspecifiquesMassiu> getDadesEspecifiquesByIdExpedientListUsingGET(String idsExpedient) throws RestClientException {
        Object postBody = null;
        
        // verify the required parameter 'idsExpedient' is set
        if (idsExpedient == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'idsExpedient' when calling getDadesEspecifiquesByIdExpedientListUsingGET");
        }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<DadesEspecifiquesRDTO> obtenirDadesEspecifiquesUsingGET(Integer idExpedient) throws RestClientException {
        Object postBody = null;
        
        // verify the required parameter 'idExpedient' is set
        if (idExpedient == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'idExpedient' when calling obtenirDadesEspecifiquesUsingGET");
        }
        
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("idExpedient", idExpedient);
        String path = UriComponentsBuilder.fromPath("/expedients/obtenirDadesEspecifiques/{idExpedient}").buildAndExpand(uriVariables).toUriString();
