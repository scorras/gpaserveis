...
public class AcumulaciExpedients_Api {
     ...
     */
    public Boolean acumularExpedientsPermesUsingGET(String ids) throws RestClientException {
        Object postBody = null;
        
        // verify the required parameter 'ids' is set
        if (ids == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'ids' when calling acumularExpedientsPermesUsingGET");
        }
