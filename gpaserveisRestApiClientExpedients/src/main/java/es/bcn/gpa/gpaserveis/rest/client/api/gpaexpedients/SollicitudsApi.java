...
public class SollicitudsApi {
	 ...
	 * <b>404</b> - Not Found
	 * 
	 * @param actualitzarDadesSollicitudSollicitudsRDTO
	 *            actualitzarDadesSollicitudSollicitudsRDTO
	 * @return SollicitudsRDTO
	 * @throws RestClientException
	 *             if an error occurs while attempting to invoke the API
	 */
	public SollicitudsRDTO actualitzarDadesSollicitudSollicituds(
			ActualitzarDadesSollicitudSollicituds actualitzarDadesSollicitudSollicitudsRDTO) throws RestClientException {
		Object postBody = actualitzarDadesSollicitudSollicitudsRDTO;

		// verify the required parameter
		// 'actualitzarDadesSollicitudSollicitudsRDTO' is set
		if (actualitzarDadesSollicitudSollicitudsRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'actualitzarDadesSollicitudSollicitudsRDTO' when calling actualitzarDadesSollicitudSollicituds");
		}
	 ...
	 * <b>404</b> - Not Found
	 * 
	 * @param sollicitudActualitzarRegistreRDTO
	 *            sollicitudActualitzarRegistreRDTO
	 * @throws RestClientException
	 *             if an error occurs while attempting to invoke the API
	 */
	public void associarRegistreSollicitud(SollicitudActualitzarRegistre sollicitudActualitzarRegistreRDTO) throws RestClientException {
		...
		// verify the required parameter 'sollicitudActualitzarRegistreRDTO' is
		// set
		if (sollicitudActualitzarRegistreRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'sollicitudActualitzarRegistreRDTO' when calling associarRegistreSollicitud");
		}
	 ...
	 * @param idExpedient
	 *            Identificador del expedient
	 * @param idTramitOvt
	 *            Identificador del tràmit OVT
	 * @param idUsuari
	 ...
	 *             if an error occurs while attempting to invoke the API
	 */
	public PageDataOfSollicitudsRDTO cercaSollicituds(Integer absoluteRowNumberOfFirstRowInCurrentPage,
			Integer absoluteRowNumberOfLastRowInCurrentPage, Boolean currentPageHasNextPage, Boolean currentPageHasPreviousPage,
			Boolean currentPageIsFirstPage, Boolean currentPageIsLastPage, Integer currentPageNumber, String dir, BigDecimal id,
			BigDecimal idExpedient, BigDecimal idTramitOvt, BigDecimal idUsuari, Integer nextPageNumber, Integer pageSize,
	...
	public SollicitudsRDTO consultarDadesSollicituds(BigDecimal id) throws RestClientException {
		...
		if (id == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'id' when calling consultarDadesSollicituds");
		}
	...
	public List<SollicitudsRDTO> consultarSollicitudsExpedient(BigDecimal idExpedient) throws RestClientException {
		...
		if (idExpedient == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'idExpedient' when calling consultarSollicitudsExpedient");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idExpedient", idExpedient);
		String path = UriComponentsBuilder.fromPath("/sollicituds/consultarSollicitudsExpedient/{idExpedient}").buildAndExpand(uriVariables)
				.toUriString();
	...
	public SollicitudsRDTO crearSollicitud(SollicitudsRDTO sollicitudsRDTO) throws RestClientException {
		...
		if (sollicitudsRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'sollicitudsRDTO' when calling crearSollicitud");
		}
	 ...
	 *             if an error occurs while attempting to invoke the API
	 */
	public RespostaCrearRegistreExpedient crearRegistreSolicitud(BigDecimal accio, CrearSollicitud registrarSolicitudRDTO)
			throws RestClientException {
		...
		if (accio == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'accio' when calling crearRegistreSolicitud");
		}

		// verify the required parameter 'registrarSolicitudRDTO' is set
		if (registrarSolicitudRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'registrarSolicitudRDTO' when calling crearRegistreSolicitud");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("accio", accio);
		String path = UriComponentsBuilder.fromPath("/expedients/registre/crearSollicitud/{accio}").buildAndExpand(uriVariables)
				.toUriString();
	...
	public SollicitudsRDTO updateSollicitud(SollicitudsRDTO sollicitudsRDTO) throws RestClientException {
		...
		if (sollicitudsRDTO == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'sollicitudsRDTO' when calling updateSollicitud");
		}
