...
public class RelacioPersonaApi {
	...
	public List<RelacioPersonaRDTO> getRelacioPersonaUsingGET(Integer esInteressada) throws ApiException {
		...
		String localVarPath = "/expedients/catalog/relacioPersona/{esInteressada}".replaceAll("\\{" + "esInteressada" + "\\}",
		        apiClient.escapeString(esInteressada.toString()));
