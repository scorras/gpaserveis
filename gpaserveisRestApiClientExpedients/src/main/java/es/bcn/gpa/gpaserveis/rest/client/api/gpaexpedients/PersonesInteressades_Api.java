...
public class PersonesInteressades_Api {
	...
	public PageDataOfPersonesSollicitudRDTO cercaPersonesInteresadesExpedient(BigDecimal idSolicitud,
		...
		if (idSolicitud == null) {
			throw new ApiException(400, "Missing the required parameter 'idSolicitud' when calling cercaPersonesInteresadesExpedient");
		}

		// create path and map variables
		String localVarPath = "/expedients/personesSollicitud/interessades/{idSolicitud}".replaceAll("\\{" + "idSolicitud" + "\\}",
		        apiClient.escapeString(idSolicitud.toString()));
