	...
	public PageDataOfPersonesSollicitudRDTO cercaPersonesInteresadesExpedient(BigDecimal idSolicitud,
		...
		if (idSolicitud == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'idSolicitud' when calling cercaPersonesInteresadesExpedient");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idSolicitud", idSolicitud);
		String path = UriComponentsBuilder.fromPath("/expedients/personesSollicitud/interessades/{idSolicitud}")
