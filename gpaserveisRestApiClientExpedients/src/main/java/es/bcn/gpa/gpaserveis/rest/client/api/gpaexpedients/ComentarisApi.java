...
public class ComentarisApi {
     ...
     */
    public void crearComentariAccio(BigDecimal idAccio, BigDecimal idExpedient, ComentariCreacioAccio comentariCreacioAccioRDTO) throws RestClientException {
    ...
    public PageDataOfComentarisRDTO deleteComentarisListUsingPOST(List<ComentarisRDTO> comentarisRDTOList, Integer absoluteRowNumberOfFirstRowInCurrentPage, Integer absoluteRowNumberOfLastRowInCurrentPage, Boolean currentPageHasNextPage, Boolean currentPageHasPreviousPage, Boolean currentPageIsFirstPage, Boolean currentPageIsLastPage, Integer currentPageNumber, String dir, Integer nextPageNumber, Integer pageSize, Integer previousPageNumber, String sort, Long totalElements, Integer totalPages) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/expedients/comentaris/delete").build().toUriString();
    ...
    public PageDataOfComentarisRDTO saveComentarisUsingPOST(ComentarisRDTO comentarisRDTO, Integer absoluteRowNumberOfFirstRowInCurrentPage, Integer absoluteRowNumberOfLastRowInCurrentPage, Boolean currentPageHasNextPage, Boolean currentPageHasPreviousPage, Boolean currentPageIsFirstPage, Boolean currentPageIsLastPage, Integer currentPageNumber, String dir, Integer nextPageNumber, Integer pageSize, Integer previousPageNumber, String sort, Long totalElements, Integer totalPages) throws RestClientException {
        ...
        if (comentarisRDTO == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'comentarisRDTO' when calling saveComentarisUsingPOST");
        }
        
        String path = UriComponentsBuilder.fromPath("/expedients/comentaris").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Boolean usuariPropietariComentariUsingGET(BigDecimal idUsuaricComentari) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/expedients/comentaris/usuariPropietariComentari/{idUsuaricComentari}").buildAndExpand(uriVariables).toUriString();
