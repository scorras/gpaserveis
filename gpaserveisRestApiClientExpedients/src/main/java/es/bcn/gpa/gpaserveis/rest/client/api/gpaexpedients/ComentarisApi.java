...
public class ComentarisApi {
	 ...
	 * @param comentariCreacioAccioRDTO
	 *            Dades del comentari (optional)
	 * @throws ApiException
	 *             if fails to make API call
	 */
	public void crearComentariAccio(BigDecimal idAccio, BigDecimal idExpedient, ComentariCreacioAccio comentariCreacioAccioRDTO)
	        throws ApiException {
	 ...
	 * 
	 * @param comentarisRDTOList
	 *            comentarisRDTOList (required)
	 ...
	 *             if fails to make API call
	 */
	public PageDataOfComentarisRDTO deleteComentarisListUsingPOST(List<ComentarisRDTO> comentarisRDTOList,
	 ...
	 * 
	 * @param comentarisRDTO
	 *            comentarisRDTO (required)
	 * @param absoluteRowNumberOfFirstRowInCurrentPage
	 *            (optional)
	 * @param absoluteRowNumberOfLastRowInCurrentPage
	 *            (optional)
	 ...
	 *             if fails to make API call
	 */
	public PageDataOfComentarisRDTO saveComentarisUsingPOST(ComentarisRDTO comentarisRDTO, Integer absoluteRowNumberOfFirstRowInCurrentPage,
