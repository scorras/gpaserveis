...
public class ComentarisApi {
	 ...
	 */
	public Integer crearComentariAccio(BigDecimal idAccio, BigDecimal idExpedient, ComentariCreacioAccio comentariCreacioAccioRDTO)
			throws RestClientException {
		...
		if (idAccio == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'idAccio' when calling crearComentariAccio");
		}

		// verify the required parameter 'idExpedient' is set
		if (idExpedient == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'idExpedient' when calling crearComentariAccio");
		}
		...
		String path = UriComponentsBuilder.fromPath("/expedients/comentaris/{idExpedient}/accions/{idAccio}/crear")
	...
	public void deleteComentari(BigDecimal idComentari, BigDecimal idExpedient) throws RestClientException {
		...
		if (idComentari == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'idComentari' when calling deleteComentari");
		}

		// verify the required parameter 'idExpedient' is set
		if (idExpedient == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'idExpedient' when calling deleteComentari");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idComentari", idComentari);
		uriVariables.put("idExpedient", idExpedient);
		String path = UriComponentsBuilder.fromPath("/expedients/comentaris/expedient/{idExpedient}/comentari/{idComentari}/delete")
				.buildAndExpand(uriVariables).toUriString();
