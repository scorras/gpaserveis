...
public class RetornTramitacio {
	...
	/**
	 * Indica si l&#39;usuari que realitza a l&#39;acció és l&#39;usuari
	 * principal de l&#39;expedient
	 * 
	...
	@Override
	public int hashCode() {
		return Objects.hash(esUsuariPrincipalExpedient, nomDescUGConvidadas, unitatsGestoresConvidadas, missatgeError);
	}
