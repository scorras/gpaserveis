...
public class Expedients_Api {
	 ...
	 *            Nivell d&#39;autenticacio del procediment
	...
	public PageDataOfExpedientsRDTO cercaExpedients(Integer absoluteRowNumberOfFirstRowInCurrentPage,
			...
			Integer nextPageNumber, Integer nivellAutenticacio, String numeroDocumentSollicitant, String numeroDocumentSollicitantEstricte,
			Integer pageSize, Integer previousPageNumber, List<String> procedimentCodisList, BigDecimal procedimentId,
			BigDecimal procedimentVersio, String sort, Long totalElements, Integer totalPages, String tramitador,
			List<BigDecimal> unitatsGestoresList) throws RestClientException {
	...
	public BigDecimal consultarExpedientPerDocumentacioIdExt(BigDecimal idDocumentacio) throws RestClientException {
		...
		if (idDocumentacio == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'idDocumentacio' when calling consultarExpedientPerDocumentacioIdExt");
		}
	...
	public MunicipisRDTO consultarMunicipiByCodi(String codiMunicipi, String codiProvincia) throws RestClientException {
		...
		if (codiMunicipi == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'codiMunicipi' when calling consultarMunicipiByCodi");
		}

		// verify the required parameter 'codiProvincia' is set
		if (codiProvincia == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'codiProvincia' when calling consultarMunicipiByCodi");
		}
		...
		String path = UriComponentsBuilder.fromPath("/geoCod/municipis/{codiProvincia}/{codiMunicipi}").buildAndExpand(uriVariables)
				.toUriString();
	...
	public PaisosRDTO consultarPaisosByCodi(String codi) throws RestClientException {
		...
		if (codi == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'codi' when calling consultarPaisosByCodi");
		}
	...
	public ProvinciesRDTO consultarProvinciesByCodi(String codi) throws RestClientException {
		...
		if (codi == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'codi' when calling consultarProvinciesByCodi");
		}
	...
	public TipusViesRDTO consultarTipusViesByCodi(String codi) throws RestClientException {
		...
		if (codi == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'codi' when calling consultarTipusViesByCodi");
		}
