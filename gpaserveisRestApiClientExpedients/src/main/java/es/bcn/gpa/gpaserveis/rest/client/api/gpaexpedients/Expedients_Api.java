...
public class Expedients_Api {
	 ...
	 *            actualitzarDadesSollicitudRDTO (required)
	...
	public ExpedientsRDTO actualitzarDadesSollicitud(ActualitzarDadesSollicitud actualitzarDadesSollicitudRDTO) throws ApiException {
		...
		return apiClient.invokeAPI(localVarPath, "PUT", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams,
	 ...
	 *            Aplicació de negoci (optional)
	 * @param avisList
	 *            Llista d&#39;avisos de l&#39;expedient (optional)
	 * @param codi
	 *            Codi de l&#39;expedient (optional)
	 * @param criteriDeCercaDadesOperacioList0Id
	 *            Identificador de la dada d&#39;operació (optional)
	 * @param criteriDeCercaDadesOperacioList0Tipus
	 *            Tipus de la dada d&#39;operació (optional)
	 * @param criteriDeCercaDadesOperacioList0Valor
	 *            Valor de la dada d&#39;operació (optional)
	 ...
	 *            Data presentació des de (optional)
	 * @param dataPresentacioFinsA
	 *            Data presentació fins a (optional)
	 * @param dir
	 *            (optional)
	 * @param estatList
	 *            Llista d&#39;estats de l&#39;expedient (optional)
	 * @param id
	 *            Identificador pel qual es realitza la cerca (optional)
	 * @param idUsuari
	 *            Identificador d&#39;usuari pel qual es realitza la cerca
	 *            (optional)
	 * @param isOge
	 *            Invocació des de OGE (optional)
	 ...
	 *            Llista dels codis dels procediments (optional)
	 * @param procedimentId
	 *            Identificador del procediment (optional)
	 * @param procedimentVersio
	 *            Versió del procediment (optional)
	 * @param sort
	 *            (optional)
	 * @param totalElements
	 *            (optional)
	 ...
	 *            (optional)
	 * @param tramitador
	 *            Tramitador de l&#39;expedient (optional)
	 * @param unitatsGestoresList
	 *            Llista d&#39;unitats gestores (optional)
	...
	public PageDataOfExpedientsRDTO cercaExpedients(Integer absoluteRowNumberOfFirstRowInCurrentPage,
	        ...
	        Integer previousPageNumber, List<String> procedimentCodisList, BigDecimal procedimentId, String procedimentVersio, String sort,
	        Long totalElements, Integer totalPages, String tramitador, List<BigDecimal> unitatsGestoresList) throws ApiException {
		...
		localVarQueryParams
		        .addAll(apiClient.parameterToPairs("", "criteriDeCercaDadesOperacioList[0].id", criteriDeCercaDadesOperacioList0Id));
		localVarQueryParams
		        .addAll(apiClient.parameterToPairs("", "criteriDeCercaDadesOperacioList[0].tipus", criteriDeCercaDadesOperacioList0Tipus));
		localVarQueryParams
		        .addAll(apiClient.parameterToPairs("", "criteriDeCercaDadesOperacioList[0].valor", criteriDeCercaDadesOperacioList0Valor));
	 ...
	 * @param id
	 *            Identificador pel qual es realitza la cerca (optional)
	 * @param idProcedimentAcumulat
	 *            Identificador del procediment de l&#39;expedient a acumular
	 *            (optional)
	 * @param idUsuari
	 *            Identificador d&#39;usuari pel qual es realitza la cerca
	 *            (optional)
	 ...
	 *            Nombre del document del sol·licitant (optional)
	 * @param pageSize
	 *            (optional)
	 * @param previousPageNumber
	 *            (optional)
	 * @param sollicitant
	 *            Nom del sol·licitant (optional)
	 * @param sort
	 *            (optional)
	 * @param totalElements
	 *            (optional)
	...
	public PageDataOfExpedientsRDTO cercaExpedientsAcumular(Integer absoluteRowNumberOfFirstRowInCurrentPage,
	        Integer absoluteRowNumberOfLastRowInCurrentPage, String codi, Boolean currentPageHasNextPage,
	        Boolean currentPageHasPreviousPage, Boolean currentPageIsFirstPage, Boolean currentPageIsLastPage, Integer currentPageNumber,
	        String dir, BigDecimal id, BigDecimal idProcedimentAcumulat, BigDecimal idUsuari, Integer nextPageNumber, String nombreDocument,
	        Integer pageSize, Integer previousPageNumber, String sollicitant, String sort, Long totalElements, Integer totalPages)
	        throws ApiException {
		Object localVarPostBody = null;
	 ...
	 *             if fails to make API call
	 */
	public PageDataOfExpedientsRDTO cercaExpedientsAcumulats(BigDecimal idExpedient, Integer absoluteRowNumberOfFirstRowInCurrentPage,
		...
		if (idExpedient == null) {
			throw new ApiException(400, "Missing the required parameter 'idExpedient' when calling cercaExpedientsAcumulats");
		}

		// create path and map variables
		String localVarPath = "/acumulacioExpedients/{idExpedient}/acumulacio/children".replaceAll("\\{" + "idExpedient" + "\\}",
		        apiClient.escapeString(idExpedient.toString()));
	...
	public ExpedientsRDTO consultarDadesExpedient(BigDecimal id) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/expedients/{id}".replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
	...
	public ExpedientsRDTO consultarDadesExpedientPerCodi(String codi) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/expedients/perCodi/{codi}".replaceAll("\\{" + "codi" + "\\}", apiClient.escapeString(codi.toString()));
	 ...
	 *            registrarSolicitudExpedientRDTO (required)
	...
	public RespostaCrearRegistreExpedient crearRegistreSolicitudExpedient(BigDecimal accio, CrearRegistre registrarSolicitudExpedientRDTO)
		...
		// create path and map variables
		String localVarPath = "/expedients/registre/crear/{accio}".replaceAll("\\{" + "accio" + "\\}",
		        apiClient.escapeString(accio.toString()));
		...
		return apiClient.invokeAPI(localVarPath, "POST", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams,
		        localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
	}
	 ...
	 *             if fails to make API call
	 */
	public InputStreamResource exportarCercaExpedientExcel(String aplicacioNegoci, List<String> avisList, String codi,
	        BigDecimal criteriDeCercaDadesOperacioList0Id, BigDecimal criteriDeCercaDadesOperacioList0Tipus,
	        String criteriDeCercaDadesOperacioList0Valor, DateTime dataPresentacioDes, DateTime dataPresentacioFinsA,
	        List<BigDecimal> estatList, BigDecimal id, BigDecimal idUsuari, Boolean isOge, String numeroDocumentSollicitant,
	        String numeroDocumentSollicitantEstricte, List<String> procedimentCodisList, BigDecimal procedimentId, String procedimentVersio,
	        String tramitador, List<BigDecimal> unitatsGestoresList) throws ApiException {
		Object localVarPostBody = null;
	 ...
	 *             if fails to make API call
	 */
	public PageDataOfExpedientsRDTO getParentExpedientUsingGET(BigDecimal idExpedient, Integer absoluteRowNumberOfFirstRowInCurrentPage,
	        Integer absoluteRowNumberOfLastRowInCurrentPage, Boolean currentPageHasNextPage, Boolean currentPageHasPreviousPage,
	        Boolean currentPageIsFirstPage, Boolean currentPageIsLastPage, Integer currentPageNumber, String dir, Integer nextPageNumber,
	        Integer pageSize, Integer previousPageNumber, String sort, Long totalElements, Integer totalPages) throws ApiException {
		Object localVarPostBody = null;
		...
		// create path and map variables
		String localVarPath = "/acumulacioExpedients/{idExpedient}/acumulacio/parent".replaceAll("\\{" + "idExpedient" + "\\}",
		        apiClient.escapeString(idExpedient.toString()));
	...
	public RespostaObtenirXmlExpedient obtenirXmlExpedient(BigDecimal idExpedient) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/expedients/obtenirXmlEvaluate/{idExpedient}".replaceAll("\\{" + "idExpedient" + "\\}",
		        apiClient.escapeString(idExpedient.toString()));
	 ...
	 *            registreDocumentacioExpedientRDTO (required)
	 * @throws ApiException
	 *             if fails to make API call
	 */
