...
public class Expedients_Api {
	...
	public PageDataOfExpedientsRDTO cercaExpedients(Integer absoluteRowNumberOfFirstRowInCurrentPage,
	        ...
	        DateTime dataPresentacioFinsA, String dir, List<BigDecimal> estatList, BigDecimal id, BigDecimal idUsuari,
	        Integer nextPageNumber, String numeroDocumentSollicitant, String numeroDocumentSollicitantEstricte, Integer pageSize,
	        Integer previousPageNumber, List<String> procedimentCodisList, String procedimentVersio, String sort, Long totalElements,
	        Integer totalPages, String tramitador, List<BigDecimal> unitatsGestoresList) throws ApiException {
	...
	public InputStreamResource exportarCercaExpedientExcel(String aplicacioNegoci, List<String> avisList, String codi,
	        ...
	        List<BigDecimal> estatList, BigDecimal id, BigDecimal idUsuari, String numeroDocumentSollicitant,
	        String numeroDocumentSollicitantEstricte, List<String> procedimentCodisList, String procedimentVersio, String tramitador,
	        List<BigDecimal> unitatsGestoresList) throws ApiException {
		Object localVarPostBody = null;
	 ...
	 *             if fails to make API call
	 */
	public PageDataOfExpedientsRDTO getChildExpedientsUsingGET(BigDecimal idExpedient, Integer absoluteRowNumberOfFirstRowInCurrentPage,
	 ...
	 *            Identificador d&#39;usuari pel qual es realitza la cerca
	 *            (optional)
	 * @param idsExpedientAcumulatList
	 *            Identificador de l&#39;expedient a acumular (optional)
	 * @param nextPageNumber
	 *            (optional)
	 ...
	 *             if fails to make API call
	 */
	public PageDataOfExpedientsRDTO searchExpedientsAcumuladorsUsingGET(Integer absoluteRowNumberOfFirstRowInCurrentPage,
	        ...
	        String dir, BigDecimal id, BigDecimal idProcedimentAcumulat, BigDecimal idUsuari, List<BigDecimal> idsExpedientAcumulatList,
	        Integer nextPageNumber, String nombreDocument, Integer pageSize, Integer previousPageNumber, String sollicitant, String sort,
	        Long totalElements, Integer totalPages) throws ApiException {
		Object localVarPostBody = null;
