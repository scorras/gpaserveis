...
public class ExpedientsRelacionatsApi {
	 ...
	 */
	public PageDataOfExpedientsRDTO obtenirExpedientsRelacionats(BigDecimal id, Integer absoluteRowNumberOfFirstRowInCurrentPage,
		...
		if (id == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'id' when calling obtenirExpedientsRelacionats");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("id", id);
		String path = UriComponentsBuilder.fromPath("/expedients/obtenirExpedientsRelacionats/{id}").buildAndExpand(uriVariables)
				.toUriString();
