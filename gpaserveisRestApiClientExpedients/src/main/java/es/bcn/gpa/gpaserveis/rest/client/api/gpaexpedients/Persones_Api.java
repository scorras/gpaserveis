	...
	public PageDataOfPersonesSollicitudRDTO cercaAltresPersonesImplicadesExpedient(BigDecimal idSolicitud,
		...
		if (idSolicitud == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
			        "Missing the required parameter 'idSolicitud' when calling cercaAltresPersonesImplicadesExpedient");
		}

		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("idSolicitud", idSolicitud);
		String path = UriComponentsBuilder.fromPath("/expedients/personesSollicitud/altresImplidades/{idSolicitud}")
