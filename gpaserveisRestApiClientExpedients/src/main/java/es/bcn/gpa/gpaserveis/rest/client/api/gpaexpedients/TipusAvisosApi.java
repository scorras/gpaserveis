...
public class TipusAvisosApi {
   ...
   */
  public List<TipusAvisosRDTO> obtenirTipusAvisosUsingGET() throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/expedients/catalog/tipusAvisos";
    ...
    GenericType<List<TipusAvisosRDTO>> localVarReturnType = new GenericType<List<TipusAvisosRDTO>>() {};
