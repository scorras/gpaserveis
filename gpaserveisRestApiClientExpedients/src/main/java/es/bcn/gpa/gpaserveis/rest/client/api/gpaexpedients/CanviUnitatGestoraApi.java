...
public class CanviUnitatGestoraApi {
     ...
     */
    public void acumularExpedientMassiuUsingPOST(AcumularExpedientRDTO acumularExpedientRDTO) throws RestClientException {
        ...
        if (acumularExpedientRDTO == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'acumularExpedientRDTO' when calling acumularExpedientMassiuUsingPOST");
        }
        
        String path = UriComponentsBuilder.fromPath("/acumulacioExpedients/acumularExpedientMassiu").build().toUriString();
