...
public class EstatsApi {
	...
	public List<EstatsRDTO> cercaHistoricsEstats(BigDecimal idExpedient) throws ApiException {
		...
		String localVarPath = "/expedients/estats/{idExpedient}/historics".replaceAll("\\{" + "idExpedient" + "\\}",
	...
	public CanviEstatRDTO getEstatsByIdExpedientUsingGET(BigDecimal idExpedient) throws ApiException {
		...
		// create path and map variables
		String localVarPath = "/expedients/estats/{idExpedient}".replaceAll("\\{" + "idExpedient" + "\\}",
		        apiClient.escapeString(idExpedient.toString()));
	 ...
	 * Returns the requested estats
	 * 
	 * @param accioEstatIdext
	 *            accioEstatIdext (required)
	...
	public List<DropdownItemRDTO> getOperacionsByAccioEstatIdextUsingGET(BigDecimal accioEstatIdext) throws ApiException {
		...
		if (accioEstatIdext == null) {
			throw new ApiException(400,
			        "Missing the required parameter 'accioEstatIdext' when calling getOperacionsByAccioEstatIdextUsingGET");
		}

		// create path and map variables
		String localVarPath = "/expedients/operacions/{accioEstatIdext}".replaceAll("\\{" + "accioEstatIdext" + "\\}",
		        apiClient.escapeString(accioEstatIdext.toString()));
