...
public class RetornarLaTramitacioApi {
     ...
     * <p><b>403</b> - Forbidden
     * <p><b>404</b> - Not Found
     * @param retornarLaTramitacioRDTO retornarLaTramitacioRDTO
    ...
    public void retornarTramitacioExpedient(RetornarLaTramitacioRDTO retornarLaTramitacioRDTO) throws RestClientException {
        ...
        if (retornarLaTramitacioRDTO == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'retornarLaTramitacioRDTO' when calling retornarTramitacioExpedient");
        }
