...
public class CanviEstatApi {
     ...
     */
    public void canviEstatUsingPOST(CanviEstatRDTO canviEstatRDTO) throws RestClientException {
        Object postBody = canviEstatRDTO;
        
        // verify the required parameter 'canviEstatRDTO' is set
        if (canviEstatRDTO == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'canviEstatRDTO' when calling canviEstatUsingPOST");
        }
        
        String path = UriComponentsBuilder.fromPath("/expedients/canviEstat").build().toUriString();
